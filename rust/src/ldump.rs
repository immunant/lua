use lobject::{lua_TValue, GCObject, TString, TValue, Value};
        ...
        if 0 != ::std::mem::size_of::<lu_byte>() as libc::c_ulong {
            ...
            __assert_fail(
                ...
                (*::std::mem::transmute::<&[u8; 46], &[libc::c_char; 46]>(
                    b"void DumpString(const TString *, DumpState *)\x00",
                )).as_ptr(),
            );
        };
...
unsafe extern "C" fn DumpBlock(
    ...
    if (*D).status == 0i32 && size > 0i32 as libc::c_ulong {
        let ref mut fresh0 = *(*(((*D).L as *mut libc::c_char)
        ...
        *fresh0 -= 1;
        ...
        let ref mut fresh1 = *(*(((*D).L as *mut libc::c_char)
            .offset(-(::std::mem::size_of::<L_EXTRA>() as libc::c_ulong as isize))
            as *mut libc::c_void as *mut L_EXTRA))
            .plock;
        let fresh2 = *fresh1;
        ...
        match (*o).tt_ & 0x3fi32 {
                ...
                if (*o).tt_ == 1i32 {
                    ...
                    __assert_fail(
                        ...
                        (*::std::mem::transmute::<&[u8; 47], &[libc::c_char; 47]>(
                            b"void DumpConstants(const Proto *, DumpState *)\x00",
                        )).as_ptr(),
                    );
                };
            ...
            4 | 20 => {
                if (*o).tt_ & 0xfi32 == 4i32 {
                    ...
                    __assert_fail(
                        b"(((((((o))->tt_)) & 0x0F)) == (4))\x00" as *const u8
                            as *const libc::c_char,
                        b"ldump.c\x00" as *const u8 as *const libc::c_char,
