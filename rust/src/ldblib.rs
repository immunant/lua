...
extern "C" {
    ...
    fn lua_getinfo(L: *mut lua_State_0, what: *const libc::c_char,
                   ar: *mut lua_Debug) -> libc::c_int;
    #[no_mangle]
    fn lua_getlocal(L: *mut lua_State_0, ar: *const lua_Debug, n: libc::c_int)
     -> *const libc::c_char;
    #[no_mangle]
    fn lua_setlocal(L: *mut lua_State_0, ar: *const lua_Debug, n: libc::c_int)
     -> *const libc::c_char;
    #[no_mangle]
    ...
    fn lua_setupvalue(L: *mut lua_State_0, funcindex: libc::c_int,
                      n: libc::c_int) -> *const libc::c_char;
    #[no_mangle]
    fn lua_upvalueid(L: *mut lua_State_0, fidx: libc::c_int, n: libc::c_int)
     -> *mut libc::c_void;
    #[no_mangle]
    fn lua_upvaluejoin(L: *mut lua_State_0, fidx1: libc::c_int,
                       n1: libc::c_int, fidx2: libc::c_int, n2: libc::c_int)
     -> ();
    #[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn luaopen_debug(mut L: *mut lua_State_0)
 -> libc::c_int {
    ...
    lua_createtable(L, 0i32,
                    (::std::mem::size_of::<[luaL_Reg_0; 17]>() as
...
static mut dblib: [luaL_Reg_0; 17] =
    unsafe {
        [luaL_Reg{name: b"debug\x00" as *const u8 as *const libc::c_char,
                  func: Some(db_debug),},
         luaL_Reg{name:
                      b"getuservalue\x00" as *const u8 as *const libc::c_char,
                  func: Some(db_getuservalue),},
         luaL_Reg{name: b"gethook\x00" as *const u8 as *const libc::c_char,
                  func: Some(db_gethook),},
         luaL_Reg{name: b"getinfo\x00" as *const u8 as *const libc::c_char,
                  func: Some(db_getinfo),},
         luaL_Reg{name: b"getlocal\x00" as *const u8 as *const libc::c_char,
                  func: Some(db_getlocal),},
         luaL_Reg{name:
                      b"getregistry\x00" as *const u8 as *const libc::c_char,
                  func: Some(db_getregistry),},
         luaL_Reg{name:
                      b"getmetatable\x00" as *const u8 as *const libc::c_char,
                  func: Some(db_getmetatable),},
         luaL_Reg{name: b"getupvalue\x00" as *const u8 as *const libc::c_char,
                  func: Some(db_getupvalue),},
         luaL_Reg{name:
                      b"upvaluejoin\x00" as *const u8 as *const libc::c_char,
                  func: Some(db_upvaluejoin),},
         luaL_Reg{name: b"upvalueid\x00" as *const u8 as *const libc::c_char,
                  func: Some(db_upvalueid),},
         luaL_Reg{name:
                      b"setuservalue\x00" as *const u8 as *const libc::c_char,
                  func: Some(db_setuservalue),},
         luaL_Reg{name: b"sethook\x00" as *const u8 as *const libc::c_char,
                  func: Some(db_sethook),},
         luaL_Reg{name: b"setlocal\x00" as *const u8 as *const libc::c_char,
                  func: Some(db_setlocal),},
         luaL_Reg{name:
                      b"setmetatable\x00" as *const u8 as *const libc::c_char,
                  func: Some(db_setmetatable),},
         luaL_Reg{name: b"setupvalue\x00" as *const u8 as *const libc::c_char,
                  func: Some(db_setupvalue),},
         luaL_Reg{name: b"traceback\x00" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn db_traceback(mut L: *mut lua_State_0) -> libc::c_int {
    ...
    let mut msg: *const libc::c_char =
        lua_tolstring(L, arg + 1i32, 0 as *mut size_t);
    if msg.is_null() && !(lua_type(L, arg + 1i32) <= 0i32) {
        lua_pushvalue(L, arg + 1i32);
    } else {
        level =
            luaL_optinteger(L, arg + 2i32,
                            (if L == L1 { 1i32 } else { 0i32 }) as
                                lua_Integer) as libc::c_int;
        luaL_traceback(L, L1, msg, level);
    }
    return 1i32;
}
unsafe extern "C" fn getthread(mut L: *mut lua_State_0,
                               mut arg: *mut libc::c_int)
 -> *mut lua_State_0 {
    if lua_type(L, 1i32) == 8i32 {
        *arg = 1i32;
        return lua_tothread(L, 1i32)
    } else { *arg = 0i32; return L };
}
unsafe extern "C" fn db_setupvalue(mut L: *mut lua_State_0) -> libc::c_int {
    luaL_checkany(L, 3i32);
    return auxupvalue(L, 0i32);
}
unsafe extern "C" fn auxupvalue(mut L: *mut lua_State_0, mut get: libc::c_int)
 -> libc::c_int {
...
unsafe extern "C" fn db_setlocal(mut L: *mut lua_State_0) -> libc::c_int {
    ...
    let mut level: libc::c_int =
        luaL_checkinteger(L, arg + 1i32) as libc::c_int;
    let mut nvar: libc::c_int =
        luaL_checkinteger(L, arg + 2i32) as libc::c_int;
    if 0 == lua_getstack(L1, level, &mut ar) {
        return luaL_argerror(L, arg + 1i32,
        ...
        if name.is_null() { lua_settop(L1, -1i32 - 1i32); }
        lua_pushstring(L, name);
        return 1i32
    };
}
unsafe extern "C" fn checkstack(mut L: *mut lua_State_0,
                                mut L1: *mut lua_State_0, mut n: libc::c_int)
 -> () {
...
unsafe extern "C" fn db_sethook(mut L: *mut lua_State_0) -> libc::c_int {
    ...
    if lua_type(L, arg + 1i32) <= 0i32 {
        ...
        count =
            luaL_optinteger(L, arg + 3i32, 0i32 as lua_Integer) as
                libc::c_int;
        func = Some(hookf);
        mask = makemask(smask, count)
    }
    if lua_rawgetp(L, -50000i32 - 1000i32,
...
unsafe extern "C" fn makemask(mut smask: *const libc::c_char,
...
unsafe extern "C" fn hookf(mut L: *mut lua_State_0, mut ar: *mut lua_Debug)
 -> () {
    ...
    if lua_rawget(L, -2i32) == 6i32 {
        ...
        if 0 !=
               lua_getinfo(L, b"lS\x00" as *const u8 as *const libc::c_char,
                           ar) {
        } else {
            __assert_fail(b"lua_getinfo(L, \"lS\", ar)\x00" as *const u8 as
                              *const libc::c_char,
                          b"ldblib.c\x00" as *const u8 as *const libc::c_char,
                          316i32 as libc::c_uint,
                          (*::std::mem::transmute::<&[u8; 37],
                                                    &[libc::c_char; 37]>(b"void hookf(lua_State *, lua_Debug *)\x00")).as_ptr());
        };
...
unsafe extern "C" fn checkupval(mut L: *mut lua_State_0,
                                mut argf: libc::c_int,
                                mut argnup: libc::c_int) -> libc::c_int {
...
unsafe extern "C" fn db_getmetatable(mut L: *mut lua_State_0) -> libc::c_int {
    ...
    if 0 == lua_getmetatable(L, 1i32) { lua_pushnil(L); }
    return 1i32;
}
...
unsafe extern "C" fn db_getinfo(mut L: *mut lua_State_0) -> libc::c_int {
    ...
    if lua_type(L, arg + 1i32) == 6i32 {
        ...
        lua_xmove(L, L1, 1i32);
                  ...
                  lua_getstack(L1,
                               luaL_checkinteger(L, arg + 1i32) as
                                   libc::c_int, &mut ar) {
        lua_pushnil(L);
        return 1i32
    }
    if 0 == lua_getinfo(L1, options, &mut ar) {
        return luaL_argerror(L, arg + 2i32,
        ...
        if !strchr(options, 'S' as i32).is_null() {
            settabss(L, b"source\x00" as *const u8 as *const libc::c_char,
                     ar.source);
            settabss(L, b"short_src\x00" as *const u8 as *const libc::c_char,
                     ar.short_src.as_mut_ptr());
            settabsi(L,
                     b"linedefined\x00" as *const u8 as *const libc::c_char,
                     ar.linedefined);
            settabsi(L,
                     b"lastlinedefined\x00" as *const u8 as
                         *const libc::c_char, ar.lastlinedefined);
        ...
        if !strchr(options, 'u' as i32).is_null() {
            ...
            settabsi(L, b"nparams\x00" as *const u8 as *const libc::c_char,
                     ar.nparams as libc::c_int);
            settabsb(L, b"isvararg\x00" as *const u8 as *const libc::c_char,
                     ar.isvararg as libc::c_int);
        }
        if !strchr(options, 'n' as i32).is_null() {
            settabss(L, b"name\x00" as *const u8 as *const libc::c_char,
                     ar.name);
            settabss(L, b"namewhat\x00" as *const u8 as *const libc::c_char,
                     ar.namewhat);
        }
        if !strchr(options, 't' as i32).is_null() {
            settabsb(L, b"istailcall\x00" as *const u8 as *const libc::c_char,
                     ar.istailcall as libc::c_int);
        }
        if !strchr(options, 'L' as i32).is_null() {
            treatstackoption(L, L1,
                             b"activelines\x00" as *const u8 as
                                 *const libc::c_char);
        }
        if !strchr(options, 'f' as i32).is_null() {
            treatstackoption(L, L1,
                             b"func\x00" as *const u8 as *const libc::c_char);
        }
        return 1i32
    };
}
unsafe extern "C" fn treatstackoption(mut L: *mut lua_State_0,
                                      mut L1: *mut lua_State_0,
                                      mut fname: *const libc::c_char) -> () {
    if L == L1 {
        lua_rotate(L, -2i32, 1i32);
    } else { lua_xmove(L1, L, 1i32); }
    lua_setfield(L, -2i32, fname);
}
unsafe extern "C" fn settabsb(mut L: *mut lua_State_0,
                              mut k: *const libc::c_char, mut v: libc::c_int)
 -> () {
    lua_pushboolean(L, v);
    lua_setfield(L, -2i32, k);
}
unsafe extern "C" fn settabss(mut L: *mut lua_State_0,
                              mut k: *const libc::c_char,
                              mut v: *const libc::c_char) -> () {
    lua_pushstring(L, v);
    lua_setfield(L, -2i32, k);
}
unsafe extern "C" fn settabsi(mut L: *mut lua_State_0,
                              mut k: *const libc::c_char, mut v: libc::c_int)
 -> () {
...
unsafe extern "C" fn db_gethook(mut L: *mut lua_State_0) -> libc::c_int {
    ...
    if hook.is_none() {
        ...
        lua_pushstring(L,
                       b"external hook\x00" as *const u8 as
                           *const libc::c_char);
    } else {
        lua_rawgetp(L, -50000i32 - 1000i32,
                    &HOOKKEY as *const libc::c_int as *const libc::c_void);
...
unsafe extern "C" fn unmakemask(mut mask: libc::c_int,
...
unsafe extern "C" fn db_debug(mut L: *mut lua_State_0) -> libc::c_int {
    loop  {
        ...
        if fgets(buffer.as_mut_ptr(),
            ...
            if 0 !=
                   luaL_loadbufferx(L, buffer.as_mut_ptr(),
                                    strlen(buffer.as_mut_ptr()),
                                    b"=(debug command)\x00" as *const u8 as
                                        *const libc::c_char,
                                    0 as *const libc::c_char) ||
                   0 !=
                       lua_pcallk(L, 0i32, 0i32, 0i32, 0i32 as lua_KContext,
                                  None) {
                fprintf(stderr,
                        b"%s\n\x00" as *const u8 as *const libc::c_char,
