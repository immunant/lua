...
extern "C" {
    ...
    fn luaD_call(L: *mut lua_State_0, func: StkId, nResults: libc::c_int)
     -> ();
    #[no_mangle]
    fn luaG_opinterror(L: *mut lua_State_0, p1: *const TValue,
                       p2: *const TValue, msg: *const libc::c_char) -> !;
    #[no_mangle]
    fn luaG_tointerror(L: *mut lua_State_0, p1: *const TValue,
                       p2: *const TValue) -> !;
    #[no_mangle]
    fn luaV_tonumber_(obj: *const TValue, n: *mut lua_Number) -> libc::c_int;
    #[no_mangle]
    fn luaG_concaterror(L: *mut lua_State_0, p1: *const TValue,
                        p2: *const TValue) -> !;
}
...
#[no_mangle]
pub static mut luaT_typenames_: [*const libc::c_char; 11] =
    unsafe {
...
static mut udatatypename: [libc::c_char; 9] =
    unsafe { [117, 115, 101, 114, 100, 97, 116, 97, 0] };
#[no_mangle]
pub unsafe extern "C" fn luaT_objtypename(mut L: *mut lua_State_0,
                                          mut o: *const TValue)
 -> *const libc::c_char {
           ...
           (*o).tt_ == 7i32 | 1i32 << 6i32 &&
               {
                   if (*o).tt_ == 7i32 | 1i32 << 6i32 {
                       ...
                       __assert_fail(b"((((o))->tt_) == (((7) | (1 << 6))))\x00"
                                         as *const u8 as *const libc::c_char,
                                     b"ltm.c\x00" as *const u8 as
                                         *const libc::c_char,
                   ...
                   if (*(*o).value_.gc).tt as libc::c_int == 7i32 {
                       ...
                       __assert_fail(b"(((o)->value_).gc)->tt == 7\x00" as
                                         *const u8 as *const libc::c_char,
                                     b"ltm.c\x00" as *const u8 as
                                         *const libc::c_char,
                                     93i32 as libc::c_uint,
                   ...
                   mt =
                       (*(&mut (*((*o).value_.gc as *mut GCUnion)).u as
                              *mut Udata)).metatable;
                   !mt.is_null()
               } {
        let mut name: *const TValue =
            luaH_getshortstr(mt,
                             luaS_new(L,
                                      b"__name\x00" as *const u8 as
                                          *const libc::c_char));
        if (*name).tt_ & 15i32 == 4i32 {
            ...
            if (*name).tt_ & 15i32 == 4i32 {
                ...
                __assert_fail(b"(((((((name))->tt_)) & 0x0F)) == (4))\x00" as
                                  *const u8 as *const libc::c_char,
                              b"ltm.c\x00" as *const u8 as
                                  *const libc::c_char, 96i32 as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 58],
            ...
            if (*(*name).value_.gc).tt as libc::c_int & 15i32 == 4i32 {
            } else {
                __assert_fail(b"(((((name)->value_).gc)->tt) & 0x0F) == 4\x00"
                                  as *const u8 as *const libc::c_char,
                              b"ltm.c\x00" as *const u8 as
                                  *const libc::c_char, 96i32 as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 58],
            ...
            return (&mut (*((*name).value_.gc as *mut GCUnion)).ts as
                        *mut TString_0 as
    ...
    return luaT_typenames_[(((*o).tt_ & 15i32) + 1i32) as usize];
}
#[no_mangle]
pub unsafe extern "C" fn luaT_gettm(mut events: *mut Table_0, mut event: TMS,
 ...
 -> *const TValue {
    ...
    if event as libc::c_uint <= TM_EQ as libc::c_int as libc::c_uint {
        ...
        __assert_fail(b"event <= TM_EQ\x00" as *const u8 as
                          *const libc::c_char,
                      b"ltm.c\x00" as *const u8 as *const libc::c_char,
                      61i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 50],
                                                &[libc::c_char; 50]>(b"const TValue *luaT_gettm(Table *, TMS, TString *)\x00")).as_ptr());
    };
    if (*tm).tt_ == 0i32 {
        (*events).flags =
            ((*events).flags as libc::c_int |
                 (1u32 << event as libc::c_uint) as lu_byte as libc::c_int) as
                lu_byte;
        return 0 as *const TValue
    } else { return tm };
}
#[no_mangle]
pub unsafe extern "C" fn luaT_gettmbyobj(mut L: *mut lua_State_0,
                                         mut o: *const TValue, mut event: TMS)
 -> *const TValue {
    let mut mt: *mut Table_0 = 0 as *mut Table_0;
    match (*o).tt_ & 15i32 {
        5 => {
            if (*o).tt_ == 5i32 | 1i32 << 6i32 {
                ...
                __assert_fail(b"((((o))->tt_) == (((5) | (1 << 6))))\x00" as
                              ...
                              (*::std::mem::transmute::<&[u8; 64],
                                                        &[libc::c_char; 64]>(b"const TValue *luaT_gettmbyobj(lua_State *, const TValue *, TMS)\x00")).as_ptr());
            };
            if (*(*o).value_.gc).tt as libc::c_int == 5i32 {
            } else {
...
pub unsafe extern "C" fn luaT_init(mut L: *mut lua_State_0) -> () {
    ...
    while i < TM_N as libc::c_int {
        (*(*L).l_G).tmname[i as usize] =
            luaS_new(L, luaT_eventname[i as usize]);
        if (*(*(*L).l_G).tmname[i as usize]).tt as libc::c_int & 15i32 <
               9i32 + 1i32 {
        } else {
            __assert_fail(b"((((L->l_G)->tmname[i])->tt) & 0x0F) < (9+1)\x00"
                              as *const u8 as *const libc::c_char,
                          b"ltm.c\x00" as *const u8 as *const libc::c_char,
                          50i32 as libc::c_uint,
                          (*::std::mem::transmute::<&[u8; 28],
                                                    &[libc::c_char; 28]>(b"void luaT_init(lua_State *)\x00")).as_ptr());
        };
        luaC_fix(L,
...
#[no_mangle]
pub unsafe extern "C" fn luaT_callTM(mut L: *mut lua_State_0,
                                     mut f: *const TValue,
                                     mut p1: *const TValue,
                                     mut p2: *const TValue,
                                     mut p3: *mut TValue,
    ...
    let mut result: ptrdiff_t =
        ((*L).stack as
             *mut libc::c_char).offset_to(p3 as
    ...
    if 0 == (*io1_0).tt_ & 1i32 << 6i32 ||
           {
               ...
               (*io1_0).tt_ & 63i32 == (*(*io1_0).value_.gc).tt as libc::c_int
                   &&
                   (L.is_null() ||
                        {
                            if 0 != (*io1_0).tt_ & 1i32 << 6i32 {
                            ...
                            0 !=
                                ((*(*io1_0).value_.gc).marked as libc::c_int ^
                                     (1i32 << 0i32 | 1i32 << 1i32)) &
                                    ((*(*L).l_G).currentwhite as libc::c_int ^
                                         (1i32 << 0i32 | 1i32 << 1i32))
                        })
    ...
    *io1_1 = *p2;
    if 0 == (*io1_1).tt_ & 1i32 << 6i32 ||
           {
               ...
               (*io1_1).tt_ & 63i32 == (*(*io1_1).value_.gc).tt as libc::c_int
                   &&
                   (L.is_null() ||
                        {
                            if 0 != (*io1_1).tt_ & 1i32 << 6i32 {
                            ...
                            0 !=
                                ((*(*io1_1).value_.gc).marked as libc::c_int ^
                                     (1i32 << 0i32 | 1i32 << 1i32)) &
                                    ((*(*L).l_G).currentwhite as libc::c_int ^
                                         (1i32 << 0i32 | 1i32 << 1i32))
                        })
    ...
    if 0 != hasres {
        p3 =
            ((*L).stack as *mut libc::c_char).offset(result as isize) as
                *mut TValue;
        ...
        if 0 == (*io1_3).tt_ & 1i32 << 6i32 ||
               {
                   ...
                   (*io1_3).tt_ & 63i32 ==
                       (*(*io1_3).value_.gc).tt as libc::c_int &&
                       (L.is_null() ||
                            {
                                if 0 != (*io1_3).tt_ & 1i32 << 6i32 {
                                } else {
...
#[no_mangle]
pub unsafe extern "C" fn luaT_callbinTM(mut L: *mut lua_State_0,
                                        mut p1: *const TValue,
                                        mut p2: *const TValue, mut res: StkId,
                                        mut event: TMS) -> libc::c_int {
    let mut tm: *const TValue = luaT_gettmbyobj(L, p1, event);
    if (*tm).tt_ == 0i32 { tm = luaT_gettmbyobj(L, p2, event) }
    if (*tm).tt_ == 0i32 {
        return 0i32
    } else { luaT_callTM(L, tm, p1, p2, res, 1i32); return 1i32 };
}
#[no_mangle]
pub unsafe extern "C" fn luaT_trybinTM(mut L: *mut lua_State_0,
                                       mut p1: *const TValue,
                                       mut p2: *const TValue, mut res: StkId,
                                       mut event: TMS) -> () {
    if 0 == luaT_callbinTM(L, p1, p2, res, event) {
        match event as libc::c_uint {
            22 => { luaG_concaterror(L, p1, p2); }
            13 | 14 | 15 | 16 | 17 | 19 => {
                ...
                if 0 !=
                       if (*p1).tt_ == 3i32 | 0i32 << 4i32 {
                           ...
                           dummy = (*p1).value_.n;
                           1i32
                       } else { luaV_tonumber_(p1, &mut dummy) } &&
                       0 !=
                           if (*p2).tt_ == 3i32 | 0i32 << 4i32 {
                               ...
                               dummy = (*p2).value_.n;
                               1i32
                           } else { luaV_tonumber_(p2, &mut dummy) } {
                    luaG_tointerror(L, p1, p2);
                } else {
                    luaG_opinterror(L, p1, p2,
                                    b"perform bitwise operation on\x00" as
                                        *const u8 as *const libc::c_char);
                }
            }
            _ => {
...
#[no_mangle]
pub unsafe extern "C" fn luaT_callorderTM(mut L: *mut lua_State_0,
                                          mut p1: *const TValue,
                                          mut p2: *const TValue,
                                          mut event: TMS) -> libc::c_int {
