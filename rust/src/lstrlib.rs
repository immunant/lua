    ...
    while *fmt as libc::c_int != '\u{0}' as i32 {
        ...
        match opt as libc::c_uint {
            ...
            2 => {
                ...
                copywithendian(u.buff.as_mut_ptr(),
                               data.offset(pos as isize),
                               size,
                               h.islittle,
                              );
...
unsafe extern "C" fn match_class(mut c: libc::c_int, mut cl: libc::c_int) -> libc::c_int {
    ...
    return if 0 != *(*__ctype_b_loc()).offset(cl as isize) as libc::c_int
        & _ISlower as libc::c_int as libc::c_ushort as libc::c_int
    {
        res
    } else {
...
unsafe extern "C" fn str_gsub(mut L: *mut lua_State_0) -> libc::c_int {
    ...
    (tr == 3i32 || tr == 4i32 || tr == 6i32 || tr == 5i32
        || 0 != luaL_argerror(
            L,
            3i32,
                        ...
                        if form[2usize] as libc::c_int == '\u{0}' as i32 {
                            ...
                            (l == strlen(s)
                                || 0 != luaL_argerror(
                                    L,
                                    arg,
                                    b"string contains zeros\x00" as *const u8
                                        as *const libc::c_char,
                                )) as libc::c_int;
...
unsafe extern "C" fn addquoted(
    ...
    *(*b).b.offset(fresh28 as isize) = '\"' as i32 as libc::c_char;
    loop {
        ...
        } else if 0 != *(*__ctype_b_loc()).offset(*s as libc::c_uchar as libc::c_int as isize)
            as libc::c_int
            & _IScntrl as libc::c_int as libc::c_ushort as libc::c_int
        {
