...
#[no_mangle]
pub unsafe extern "C" fn luaopen_coroutine(mut L: *mut lua_State_0)
 -> libc::c_int {
...
static mut co_funcs: [luaL_Reg; 8] =
    unsafe {
        [luaL_Reg_0{name: b"create\x00" as *const u8 as *const libc::c_char,
                    func: Some(luaB_cocreate),},
         luaL_Reg_0{name: b"resume\x00" as *const u8 as *const libc::c_char,
                    func: Some(luaB_coresume),},
         luaL_Reg_0{name: b"running\x00" as *const u8 as *const libc::c_char,
                    func: Some(luaB_corunning),},
         luaL_Reg_0{name: b"status\x00" as *const u8 as *const libc::c_char,
                    func: Some(luaB_costatus),},
         luaL_Reg_0{name: b"wrap\x00" as *const u8 as *const libc::c_char,
                    func: Some(luaB_cowrap),},
         luaL_Reg_0{name: b"yield\x00" as *const u8 as *const libc::c_char,
                    func: Some(luaB_yield),},
         luaL_Reg_0{name:
                        b"isyieldable\x00" as *const u8 as
                            *const libc::c_char,
...
unsafe extern "C" fn luaB_auxwrap(mut L: *mut lua_State_0) -> libc::c_int {
    let mut co: *mut lua_State_0 =
        lua_tothread(L, -50000i32 - 1000i32 - 1i32);
...
unsafe extern "C" fn auxresume(mut L: *mut lua_State_0,
                               mut co: *mut lua_State_0,
                               mut narg: libc::c_int) -> libc::c_int {
    let mut status: libc::c_int = 0;
    if 0 == lua_checkstack(co, narg) {
        lua_pushstring(L,
                       b"too many arguments to resume\x00" as *const u8 as
                           *const libc::c_char);
        return -1i32
    } else if lua_status(co) == 0i32 && lua_gettop(co) == 0i32 {
        lua_pushstring(L,
                       b"cannot resume dead coroutine\x00" as *const u8 as
                           *const libc::c_char);
        return -1i32
    } else {
        lua_xmove(L, co, narg);
        ...
        if status == 0i32 || status == 1i32 {
            ...
            if 0 == lua_checkstack(L, nres + 1i32) {
                ...
                lua_pushstring(L,
                               b"too many results to resume\x00" as *const u8
                                   as *const libc::c_char);
                return -1i32
            } else { lua_xmove(co, L, nres); return nres }
        } else { lua_xmove(co, L, 1i32); return -1i32 }
    };
}
...
unsafe extern "C" fn luaB_costatus(mut L: *mut lua_State_0) -> libc::c_int {
    ...
    if L == co {
        ...
        match lua_status(co) {
            1 => {
                lua_pushstring(L,
                               b"suspended\x00" as *const u8 as
                                   *const libc::c_char);
            }
            0 => {
