...
extern "C" {
    ...
    #[no_mangle]
    fn luaV_lessequal(L: *mut lua_State_0, l: *const TValue, r: *const TValue)
     -> libc::c_int;
    #[no_mangle]
    fn luaV_lessthan(L: *mut lua_State_0, l: *const TValue, r: *const TValue)
     -> libc::c_int;
    #[no_mangle]
    ...
    fn luaS_new(L: *mut lua_State_0, str: *const libc::c_char)
     -> *mut TString;
    #[no_mangle]
    fn luaO_pushvfstring(L: *mut lua_State_0, fmt: *const libc::c_char,
                         argp: *mut __va_list_tag) -> *const libc::c_char;
    #[no_mangle]
    fn luaF_newCclosure(L: *mut lua_State_0, nelems: libc::c_int)
     -> *mut CClosure;
    #[no_mangle]
    fn luaH_getint(t: *mut Table_0, key: lua_Integer) -> *const TValue;
    #[no_mangle]
    fn luaV_finishget(L: *mut lua_State_0, t: *const TValue, key: *mut TValue,
                      val: StkId, slot: *const TValue) -> ();
    #[no_mangle]
    ...
    #[no_mangle]
    fn luaV_finishset(L: *mut lua_State_0, t: *const TValue, key: *mut TValue,
                      val: StkId, slot: *const TValue) -> ();
    #[no_mangle]
    ...
    fn luaH_setint(L: *mut lua_State_0, t: *mut Table_0, key: lua_Integer,
                   value: *mut TValue) -> ();
    #[no_mangle]
    fn luaC_checkfinalizer(L: *mut lua_State_0, o: *mut GCObject,
                           mt: *mut Table_0) -> ();
    #[no_mangle]
    ...
    #[no_mangle]
    fn luaD_protectedparser(L: *mut lua_State_0, z: *mut ZIO,
                            name: *const libc::c_char,
                            mode: *const libc::c_char) -> libc::c_int;
    #[no_mangle]
    fn luaZ_init(L: *mut lua_State_0, z: *mut ZIO, reader: lua_Reader,
                 data: *mut libc::c_void) -> ();
    #[no_mangle]
    fn luaU_dump(L: *mut lua_State_0, f: *const Proto_0, w: lua_Writer,
    ...
    #[no_mangle]
    fn luaH_next(L: *mut lua_State_0, t: *mut Table_0, key: StkId)
     -> libc::c_int;
    #[no_mangle]
...
pub static mut lua_ident: [libc::c_char; 129] =
    unsafe {
        [36, 76, 117, 97, 86, 101, 114, 115, 105, 111, 110, 58, 32, 76, 117,
         97, 32, 53, 46, 51, 46, 52, 32, 32, 67, 111, 112, 121, 114, 105, 103,
         104, 116, 32, 40, 67, 41, 32, 49, 57, 57, 52, 45, 50, 48, 49, 55, 32,
         76, 117, 97, 46, 111, 114, 103, 44, 32, 80, 85, 67, 45, 82, 105, 111,
         32, 36, 36, 76, 117, 97, 65, 117, 116, 104, 111, 114, 115, 58, 32,
         82, 46, 32, 73, 101, 114, 117, 115, 97, 108, 105, 109, 115, 99, 104,
         121, 44, 32, 76, 46, 32, 72, 46, 32, 100, 101, 32, 70, 105, 103, 117,
         101, 105, 114, 101, 100, 111, 44, 32, 87, 46, 32, 67, 101, 108, 101,
         115, 32, 36, 0]
    };
#[no_mangle]
pub unsafe extern "C" fn lua_atpanic(mut L: *mut lua_State_0,
    ...
    *fresh3 = *fresh3 + 1;
    ...
    if idx >= 0i32 {
        if idx as libc::c_long <=
               func.offset(1isize).offset_to((*L).stack_last).expect("bad offset_to")
                   as libc::c_long &&
               !(b"new top too large\x00" as *const u8 as
                     *const libc::c_char).is_null() {
        } else {
            __assert_fail(b"(idx <= L->stack_last - (func + 1)) && \"new top too large\"\x00"
                              as *const u8 as *const libc::c_char,
                          b"lapi.c\x00" as *const u8 as *const libc::c_char,
        ...
        if -(idx + 1i32) as libc::c_long <=
               func.offset(1isize).offset_to((*L).top).expect("bad offset_to")
                   as libc::c_long &&
               !(b"invalid new top\x00" as *const u8 as
                     *const libc::c_char).is_null() {
        } else {
            __assert_fail(b"(-(idx+1) <= (L->top - (func + 1))) && \"invalid new top\"\x00"
                              as *const u8 as *const libc::c_char,
                          b"lapi.c\x00" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub unsafe extern "C" fn lua_pushvalue(mut L: *mut lua_State_0,
                                       mut idx: libc::c_int) -> () {
    let ref mut fresh7 =
        *(*((L as
                 *mut libc::c_char).offset(-(::std::mem::size_of::<L_EXTRA>()
...
unsafe extern "C" fn index2addr(mut L: *mut lua_State_0, mut idx: libc::c_int)
 -> *mut TValue {
    let mut ci: *mut CallInfo_0 = (*L).ci;
    if idx > 0i32 {
        let mut o: *mut TValue = (*ci).func.offset(idx as isize);
        if idx as libc::c_long <=
               (*ci).func.offset(1isize).offset_to((*ci).top).expect("bad offset_to")
                   as libc::c_long &&
               !(b"unacceptable index\x00" as *const u8 as
                     *const libc::c_char).is_null() {
        } else {
            __assert_fail(b"(idx <= ci->top - (ci->func + 1)) && \"unacceptable index\"\x00"
                              as *const u8 as *const libc::c_char,
                          b"lapi.c\x00" as *const u8 as *const libc::c_char,
                          65i32 as libc::c_uint,
                          (*::std::mem::transmute::<&[u8; 37],
                                                    &[libc::c_char; 37]>(b"TValue *index2addr(lua_State *, int)\x00")).as_ptr());
        };
        if o >= (*L).top {
        ...
        if idx != 0i32 &&
               -idx as libc::c_long <=
                   (*ci).func.offset(1isize).offset_to((*L).top).expect("bad offset_to")
                       as libc::c_long &&
               !(b"invalid index\x00" as *const u8 as
                     *const libc::c_char).is_null() {
        } else {
            __assert_fail(b"(idx != 0 && -idx <= L->top - (ci->func + 1)) && \"invalid index\"\x00"
                              as *const u8 as *const libc::c_char,
                          b"lapi.c\x00" as *const u8 as *const libc::c_char,
        ...
        return &mut (*(*L).l_G).l_registry as *mut TValue
    } else {
        idx = -50000i32 - 1000i32 - idx;
        if idx <= 255i32 + 1i32 &&
               !(b"upvalue index too large\x00" as *const u8 as
                     *const libc::c_char).is_null() {
        } else {
            __assert_fail(b"(idx <= 255 + 1) && \"upvalue index too large\"\x00"
                              as *const u8 as *const libc::c_char,
                          b"lapi.c\x00" as *const u8 as *const libc::c_char,
        ...
        if (*(*ci).func).tt_ == 6i32 | 1i32 << 4i32 {
            ...
            if (*(*ci).func).tt_ == 6i32 | 2i32 << 4i32 | 1i32 << 6i32 {
                ...
                __assert_fail(b"((((ci->func))->tt_) == ((((6 | (2 << 4))) | (1 << 6))))\x00"
                                  as *const u8 as *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
            ...
            if (*(*(*ci).func).value_.gc).tt as libc::c_int ==
                ...
                __assert_fail(b"(((ci->func)->value_).gc)->tt == (6 | (2 << 4))\x00"
                                  as *const u8 as *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
                                  *const libc::c_char, 81i32 as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 37],
            ...
            let mut func: *mut CClosure =
                &mut (*((*(*ci).func).value_.gc as *mut GCUnion)).cl.c as
                    *mut CClosure;
            return if idx <= (*func).nupvalues as libc::c_int {
                       &mut (*func).upvalue[(idx - 1i32) as usize] as
                           *mut TValue
                   } else { &luaO_nilobject_ as *const TValue as *mut TValue }
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn lua_rotate(mut L: *mut lua_State_0,
                                    mut idx: libc::c_int, mut n: libc::c_int)
 -> () {
    ...
    *fresh10 = *fresh10 + 1;
    ...
    if p != &luaO_nilobject_ as *const TValue as StkId &&
           ...
           !(b"index not in the stack\x00" as *const u8 as
                 *const libc::c_char).is_null() {
    } else {
    ...
    if (if n >= 0i32 { n } else { -n }) as libc::c_long <=
           p.offset_to(t).expect("bad offset_to") as libc::c_long +
               1i32 as libc::c_long &&
           !(b"invalid \'n\'\x00" as *const u8 as
                 *const libc::c_char).is_null() {
    } else {
        __assert_fail(b"((n >= 0 ? n : -n) <= (t - p + 1)) && \"invalid \'n\'\"\x00"
                          as *const u8 as *const libc::c_char,
                      b"lapi.c\x00" as *const u8 as *const libc::c_char,
    ...
    m =
        if n >= 0i32 {
            t.offset(-(n as isize))
        } else { p.offset(-(n as isize)).offset(-1isize) };
    reverse(L, p, m);
...
unsafe extern "C" fn reverse(mut L: *mut lua_State_0, mut from: StkId,
                             mut to: StkId) -> () {
    while from < to {
        let mut temp: TValue =
            lua_TValue{value_:
                   ...
                   if 0 != (*io1).tt_ & 1i32 << 6i32 {
                       ...
                       __assert_fail(b"(((io1)->tt_) & (1 << 6))\x00" as
                                     ...
                                     (*::std::mem::transmute::<&[u8; 40],
                                                               &[libc::c_char; 40]>(b"void reverse(lua_State *, StkId, StkId)\x00")).as_ptr());
                   };
                   (*io1).tt_ & 63i32 == (*(*io1).value_.gc).tt as libc::c_int
                       &&
                       (L.is_null() ||
...
#[no_mangle]
pub unsafe extern "C" fn lua_copy(mut L: *mut lua_State_0,
    ...
    *fresh13 = *fresh13 + 1;
    ...
    if to != &luaO_nilobject_ as *const TValue as *mut TValue &&
        ...
        __assert_fail(b"(((to) != (&luaO_nilobject_))) && \"invalid index\"\x00"
                          as *const u8 as *const libc::c_char,
                      b"lapi.c\x00" as *const u8 as *const libc::c_char,
    ...
    *io1 = *fr;
    ...
    if toidx < -50000i32 - 1000i32 {
        if 0 != (*fr).tt_ & 1i32 << 6i32 &&
               {
                   if (*(*(*L).ci).func).tt_ ==
                          6i32 | 2i32 << 4i32 | 1i32 << 6i32 {
                   } else {
                       __assert_fail(b"((((L->ci->func))->tt_) == ((((6 | (2 << 4))) | (1 << 6))))\x00"
                                         as *const u8 as *const libc::c_char,
                                     b"lapi.c\x00" as *const u8 as
                                         *const libc::c_char,
                   ...
                   if (*(*(*(*L).ci).func).value_.gc).tt as libc::c_int ==
                          6i32 | 2i32 << 4i32 {
                   } else {
                       __assert_fail(b"(((L->ci->func)->value_).gc)->tt == (6 | (2 << 4))\x00"
                                         as *const u8 as *const libc::c_char,
                                     b"lapi.c\x00" as *const u8 as
                                         *const libc::c_char,
                                     231i32 as libc::c_uint,
                   ...
                   0 !=
                       (*(&mut (*((*(*(*L).ci).func).value_.gc as
                                      *mut GCUnion)).cl.c as
                              *mut CClosure)).marked as libc::c_int &
                           1i32 << 2i32
               } &&
               {
                   if 0 != (*fr).tt_ & 1i32 << 6i32 {
                   } else {
                       __assert_fail(b"(((fr)->tt_) & (1 << 6))\x00" as
                                         *const u8 as *const libc::c_char,
                                     b"lapi.c\x00" as *const u8 as
                                         *const libc::c_char,
                                     231i32 as libc::c_uint,
            ...
            if (*(&mut (*((*(*(*L).ci).func).value_.gc as *mut GCUnion)).cl.c
                      as *mut CClosure)).tt as libc::c_int & 15i32 <
                   9i32 + 1i32 {
            } else {
            ...
            if 0 != (*fr).tt_ & 1i32 << 6i32 {
                ...
                __assert_fail(b"(((fr)->tt_) & (1 << 6))\x00" as *const u8 as
                                  *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
                                  *const libc::c_char, 231i32 as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 37],
            ...
            luaC_barrier_(L,
                          &mut (*(&mut (*((*(*(*L).ci).func).value_.gc as
                                              *mut GCUnion)).cl.c as
                                      *mut CClosure as *mut GCUnion)).gc,
                          (*fr).value_.gc);
        } else { };
    }
    let ref mut fresh15 =
...
#[no_mangle]
pub unsafe extern "C" fn lua_checkstack(mut L: *mut lua_State_0,
    ...
    *fresh16 = *fresh16 + 1;
    ...
    if n >= 0i32 &&
           !(b"negative \'n\'\x00" as *const u8 as
                 *const libc::c_char).is_null() {
    } else {
        __assert_fail(b"(n >= 0) && \"negative \'n\'\"\x00" as *const u8 as
                          *const libc::c_char,
                      b"lapi.c\x00" as *const u8 as *const libc::c_char,
    ...
    if (*L).top.offset_to((*L).stack_last).expect("bad offset_to") as
           libc::c_long > n as libc::c_long {
        res = 1i32
    } else {
        let mut inuse: libc::c_int =
            (*L).stack.offset_to((*L).top).expect("bad offset_to") as
                libc::c_long as libc::c_int + 5i32;
        if inuse > 50000i32 - n {
            res = 0i32
        } else {
            res =
                (luaD_rawrunprotected(L, Some(growstack),
                                      &mut n as *mut libc::c_int as
                                          *mut libc::c_void) == 0i32) as
                    libc::c_int
        }
    }
...
unsafe extern "C" fn growstack(mut L: *mut lua_State_0,
                               mut ud: *mut libc::c_void) -> () {
    let mut size: libc::c_int = *(ud as *mut libc::c_int);
    luaD_growstack(L, size);
}
#[no_mangle]
pub unsafe extern "C" fn lua_xmove(mut from: *mut lua_State_0,
    ...
    if from == to {
        ...
        *fresh19 = *fresh19 + 1;
        ...
        if (n as libc::c_long) <
               (*(*from).ci).func.offset_to((*from).top).expect("bad offset_to")
                   as libc::c_long &&
               !(b"not enough elements in the stack\x00" as *const u8 as
                     *const libc::c_char).is_null() {
        } else {
            __assert_fail(b"((n) < (from->top - from->ci->func)) && \"not enough elements in the stack\"\x00"
                              as *const u8 as *const libc::c_char,
                          b"lapi.c\x00" as *const u8 as *const libc::c_char,
        ...
        if (*from).l_G == (*to).l_G &&
               !(b"moving among independent states\x00" as *const u8 as
                     *const libc::c_char).is_null() {
        } else {
            __assert_fail(b"((from->l_G) == (to->l_G)) && \"moving among independent states\"\x00"
                              as *const u8 as *const libc::c_char,
                          b"lapi.c\x00" as *const u8 as *const libc::c_char,
        ...
        if (*to).top.offset_to((*(*to).ci).top).expect("bad offset_to") as
               libc::c_long >= n as libc::c_long &&
               !(b"stack overflow\x00" as *const u8 as
                     *const libc::c_char).is_null() {
        } else {
            __assert_fail(b"(to->ci->top - to->top >= n) && \"stack overflow\"\x00"
                              as *const u8 as *const libc::c_char,
                          b"lapi.c\x00" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub unsafe extern "C" fn lua_isnumber(mut L: *mut lua_State_0,
                                      mut idx: libc::c_int) -> libc::c_int {
               ...
               if (*o).tt_ == 3i32 | 0i32 << 4i32 {
                   ...
                   __assert_fail(b"((((o))->tt_) == ((3 | (0 << 4))))\x00" as
                                 ...
                                 (*::std::mem::transmute::<&[u8; 35],
                                                           &[libc::c_char; 35]>(b"int lua_isnumber(lua_State *, int)\x00")).as_ptr());
               };
               n = (*o).value_.n;
               1i32
           } else { luaV_tonumber_(o, &mut n) };
}
#[no_mangle]
pub unsafe extern "C" fn lua_isstring(mut L: *mut lua_State_0,
                                      mut idx: libc::c_int) -> libc::c_int {
    let mut o: *const TValue = index2addr(L, idx);
    return ((*o).tt_ & 15i32 == 4i32 || (*o).tt_ & 15i32 == 3i32) as
               libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn lua_iscfunction(mut L: *mut lua_State_0,
                                         mut idx: libc::c_int)
 -> libc::c_int {
    let mut o: StkId = index2addr(L, idx);
    return ((*o).tt_ == 6i32 | 1i32 << 4i32 ||
                (*o).tt_ == 6i32 | 2i32 << 4i32 | 1i32 << 6i32) as
               libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn lua_isinteger(mut L: *mut lua_State_0,
                                       mut idx: libc::c_int) -> libc::c_int {
    let mut o: StkId = index2addr(L, idx);
    return ((*o).tt_ == 3i32 | 1i32 << 4i32) as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn lua_isuserdata(mut L: *mut lua_State_0,
                                        mut idx: libc::c_int) -> libc::c_int {
    let mut o: *const TValue = index2addr(L, idx);
    return ((*o).tt_ == 7i32 | 1i32 << 6i32 || (*o).tt_ == 2i32) as
               libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn lua_type(mut L: *mut lua_State_0,
                                  mut idx: libc::c_int) -> libc::c_int {
    let mut o: StkId = index2addr(L, idx);
...
#[no_mangle]
pub unsafe extern "C" fn lua_typename(mut L: *mut lua_State_0,
                                      mut t: libc::c_int)
 -> *const libc::c_char {
    L = 0 as *mut lua_State_0;
    if -1i32 <= t && t < 9i32 &&
           !(b"invalid tag\x00" as *const u8 as *const libc::c_char).is_null()
       {
    } else {
        __assert_fail(b"((-1) <= t && t < 9) && \"invalid tag\"\x00" as
                          *const u8 as *const libc::c_char,
                      b"lapi.c\x00" as *const u8 as *const libc::c_char,
                      260i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 43],
                                                &[libc::c_char; 43]>(b"const char *lua_typename(lua_State *, int)\x00")).as_ptr());
    };
    return luaT_typenames_[(t + 1i32) as usize];
}
#[no_mangle]
pub unsafe extern "C" fn lua_tonumberx(mut L: *mut lua_State_0,
                                       mut idx: libc::c_int,
        ...
        if (*o).tt_ == 3i32 | 0i32 << 4i32 {
            if (*o).tt_ == 3i32 | 0i32 << 4i32 {
                ...
                __assert_fail(b"((((o))->tt_) == ((3 | (0 << 4))))\x00" as
                                  *const u8 as *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
                                  *const libc::c_char, 349i32 as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 50],
                                                        &[libc::c_char; 50]>(b"lua_Number lua_tonumberx(lua_State *, int, int *)\x00")).as_ptr());
            };
            n = (*o).value_.n;
            1i32
        } else { luaV_tonumber_(o, &mut n) };
    if 0 == isnum { n = 0i32 as lua_Number }
    if !pisnum.is_null() { *pisnum = isnum }
    return n;
}
#[no_mangle]
pub unsafe extern "C" fn lua_tointegerx(mut L: *mut lua_State_0,
                                        mut idx: libc::c_int,
                                        mut pisnum: *mut libc::c_int)
 -> lua_Integer {
            ...
            if (*o).tt_ == 3i32 | 1i32 << 4i32 {
                ...
                __assert_fail(b"((((o))->tt_) == ((3 | (1 << 4))))\x00" as
                              ...
                              (*::std::mem::transmute::<&[u8; 52],
                                                        &[libc::c_char; 52]>(b"lua_Integer lua_tointegerx(lua_State *, int, int *)\x00")).as_ptr());
            };
            res = (*o).value_.i;
            1i32
        } else { luaV_tointeger(o, &mut res, 0i32) };
    if 0 == isnum { res = 0i32 as lua_Integer }
    if !pisnum.is_null() { *pisnum = isnum }
    return res;
}
#[no_mangle]
pub unsafe extern "C" fn lua_toboolean(mut L: *mut lua_State_0,
                                       mut idx: libc::c_int) -> libc::c_int {
    let mut o: *const TValue = index2addr(L, idx);
    return !((*o).tt_ == 0i32 ||
                 (*o).tt_ == 1i32 &&
                     {
                         if (*o).tt_ == 1i32 {
                             ...
                             __assert_fail(b"((((o))->tt_) == (1))\x00" as
                                               *const u8 as
                                               *const libc::c_char,
                                           b"lapi.c\x00" as *const u8 as
                                               *const libc::c_char,
                                           ...
                                           (*::std::mem::transmute::<&[u8; 36],
                                                                     &[libc::c_char; 36]>(b"int lua_toboolean(lua_State *, int)\x00")).as_ptr());
                         };
                         (*o).value_.b == 0i32
                     }) as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn lua_tolstring(mut L: *mut lua_State_0,
                                       mut idx: libc::c_int,
                                       mut len: *mut size_t)
 -> *const libc::c_char {
    let mut o: StkId = index2addr(L, idx);
    if !((*o).tt_ & 15i32 == 4i32) {
        if !((*o).tt_ & 15i32 == 3i32) {
            if !len.is_null() { *len = 0i32 as size_t }
    ...
    if (*o).tt_ & 15i32 == 4i32 {
        ...
        __assert_fail(b"(((((((o))->tt_)) & 0x0F)) == (4))\x00" as *const u8
                          as *const libc::c_char,
                      b"lapi.c\x00" as *const u8 as *const libc::c_char,
                      389i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 54],
    ...
    return (&mut (*((*o).value_.gc as *mut GCUnion)).ts as *mut TString_0 as
                *mut libc::c_char).offset(::std::mem::size_of::<UTString>() as
                                              libc::c_ulong as isize);
}
#[no_mangle]
pub unsafe extern "C" fn lua_rawlen(mut L: *mut lua_State_0,
                                    mut idx: libc::c_int) -> size_t {
    let mut o: StkId = index2addr(L, idx);
    match (*o).tt_ & 63i32 {
        4 => {
            if (*o).tt_ & 15i32 == 4i32 {
                ...
                __assert_fail(b"(((((((o))->tt_)) & 0x0F)) == (4))\x00" as
                                  *const u8 as *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
                                  *const libc::c_char, 396i32 as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 36],
                                                        &[libc::c_char; 36]>(b"size_t lua_rawlen(lua_State *, int)\x00")).as_ptr());
            };
            if (*(*o).value_.gc).tt as libc::c_int & 15i32 == 4i32 {
            } else {
                __assert_fail(b"(((((o)->value_).gc)->tt) & 0x0F) == 4\x00" as
            ...
            return (*(&mut (*((*o).value_.gc as *mut GCUnion)).ts as
                          *mut TString_0)).shrlen as size_t
        }
        20 => {
            if (*o).tt_ & 15i32 == 4i32 {
            } else {
                __assert_fail(b"(((((((o))->tt_)) & 0x0F)) == (4))\x00" as
                                  *const u8 as *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
                                  *const libc::c_char, 397i32 as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 36],
                                                        &[libc::c_char; 36]>(b"size_t lua_rawlen(lua_State *, int)\x00")).as_ptr());
            };
            if (*(*o).value_.gc).tt as libc::c_int & 15i32 == 4i32 {
        ...
        7 => {
            if (*o).tt_ == 7i32 | 1i32 << 6i32 {
                ...
                __assert_fail(b"((((o))->tt_) == (((7) | (1 << 6))))\x00" as
                                  *const u8 as *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
                                  *const libc::c_char, 398i32 as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 36],
                                                        &[libc::c_char; 36]>(b"size_t lua_rawlen(lua_State *, int)\x00")).as_ptr());
            };
            if (*(*o).value_.gc).tt as libc::c_int == 7i32 {
            } else {
                __assert_fail(b"(((o)->value_).gc)->tt == 7\x00" as *const u8
                                  as *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
                                  *const libc::c_char, 398i32 as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 36],
            ...
            return (*(&mut (*((*o).value_.gc as *mut GCUnion)).u as
                          *mut Udata)).len
        }
        5 => {
            if (*o).tt_ == 5i32 | 1i32 << 6i32 {
            } else {
                __assert_fail(b"((((o))->tt_) == (((5) | (1 << 6))))\x00" as
                                  *const u8 as *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
            ...
            if (*(*o).value_.gc).tt as libc::c_int == 5i32 {
                ...
                __assert_fail(b"(((o)->value_).gc)->tt == 5\x00" as *const u8
                                  as *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
                                  *const libc::c_char, 399i32 as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 36],
            ...
            return luaH_getn(&mut (*((*o).value_.gc as *mut GCUnion)).h) as
                       size_t
        }
...
#[no_mangle]
pub unsafe extern "C" fn lua_tocfunction(mut L: *mut lua_State_0,
                                         mut idx: libc::c_int)
 -> lua_CFunction {
    let mut o: StkId = index2addr(L, idx);
    if (*o).tt_ == 6i32 | 1i32 << 4i32 {
        if (*o).tt_ == 6i32 | 1i32 << 4i32 {
            ...
            __assert_fail(b"((((o))->tt_) == ((6 | (1 << 4))))\x00" as
                              *const u8 as *const libc::c_char,
                          b"lapi.c\x00" as *const u8 as *const libc::c_char,
                          407i32 as libc::c_uint,
                          (*::std::mem::transmute::<&[u8; 48],
                                                    &[libc::c_char; 48]>(b"lua_CFunction lua_tocfunction(lua_State *, int)\x00")).as_ptr());
        };
        return (*o).value_.f
    } else if (*o).tt_ == 6i32 | 2i32 << 4i32 | 1i32 << 6i32 {
        if (*o).tt_ == 6i32 | 2i32 << 4i32 | 1i32 << 6i32 {
        } else {
            __assert_fail(b"((((o))->tt_) == ((((6 | (2 << 4))) | (1 << 6))))\x00"
                              as *const u8 as *const libc::c_char,
                          b"lapi.c\x00" as *const u8 as *const libc::c_char,
        ...
        if (*(*o).value_.gc).tt as libc::c_int == 6i32 | 2i32 << 4i32 {
            ...
            __assert_fail(b"(((o)->value_).gc)->tt == (6 | (2 << 4))\x00" as
                              *const u8 as *const libc::c_char,
                          b"lapi.c\x00" as *const u8 as *const libc::c_char,
                          409i32 as libc::c_uint,
                          (*::std::mem::transmute::<&[u8; 48],
        ...
        return (*(&mut (*((*o).value_.gc as *mut GCUnion)).cl.c as
                      *mut CClosure)).f
    } else { return None };
}
#[no_mangle]
pub unsafe extern "C" fn lua_touserdata(mut L: *mut lua_State_0,
                                        mut idx: libc::c_int)
 -> *mut libc::c_void {
    let mut o: StkId = index2addr(L, idx);
    match (*o).tt_ & 15i32 {
        7 => {
            ...
            return (&mut (*((*o).value_.gc as *mut GCUnion)).u as *mut Udata
                        as
                        *mut libc::c_char).offset(::std::mem::size_of::<UUdata>()
                                                      as libc::c_ulong as
                                                      isize) as
                       *mut libc::c_void
        }
        2 => {
            if (*o).tt_ == 2i32 {
                ...
                __assert_fail(b"((((o))->tt_) == (2))\x00" as *const u8 as
                                  *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn lua_tothread(mut L: *mut lua_State_0,
                                      mut idx: libc::c_int)
 -> *mut lua_State_0 {
    let mut o: StkId = index2addr(L, idx);
    return if !((*o).tt_ == 8i32 | 1i32 << 6i32) {
               ...
               if (*o).tt_ == 8i32 | 1i32 << 6i32 {
                   ...
                   __assert_fail(b"((((o))->tt_) == (((8) | (1 << 6))))\x00"
                                     as *const u8 as *const libc::c_char,
                                 b"lapi.c\x00" as *const u8 as
                                     *const libc::c_char,
                                 426i32 as libc::c_uint,
                                 (*::std::mem::transmute::<&[u8; 42],
                                                           &[libc::c_char; 42]>(b"lua_State *lua_tothread(lua_State *, int)\x00")).as_ptr());
               };
               if (*(*o).value_.gc).tt as libc::c_int == 8i32 {
               } else {
                   __assert_fail(b"(((o)->value_).gc)->tt == 8\x00" as
                                     *const u8 as *const libc::c_char,
                                 b"lapi.c\x00" as *const u8 as
                                     *const libc::c_char,
                                 426i32 as libc::c_uint,
               ...
               &mut (*((*o).value_.gc as *mut GCUnion)).th as *mut lua_State
           };
}
#[no_mangle]
pub unsafe extern "C" fn lua_topointer(mut L: *mut lua_State_0,
                                       mut idx: libc::c_int)
 -> *const libc::c_void {
    let mut o: StkId = index2addr(L, idx);
    match (*o).tt_ & 63i32 {
        5 => {
            if (*o).tt_ == 5i32 | 1i32 << 6i32 {
                ...
                __assert_fail(b"((((o))->tt_) == (((5) | (1 << 6))))\x00" as
                                  *const u8 as *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
                                  *const libc::c_char, 433i32 as libc::c_uint,
            ...
            return &mut (*((*o).value_.gc as *mut GCUnion)).h as *mut Table as
                       *const libc::c_void
        }
        6 => {
            if (*o).tt_ == 6i32 | 0i32 << 4i32 | 1i32 << 6i32 {
            } else {
                __assert_fail(b"((((o))->tt_) == ((((6 | (0 << 4))) | (1 << 6))))\x00"
                                  as *const u8 as *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
                                  *const libc::c_char, 434i32 as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 44],
                                                        &[libc::c_char; 44]>(b"const void *lua_topointer(lua_State *, int)\x00")).as_ptr());
            };
            if (*(*o).value_.gc).tt as libc::c_int == 6i32 | 0i32 << 4i32 {
            } else {
                __assert_fail(b"(((o)->value_).gc)->tt == (6 | (0 << 4))\x00"
                                  as *const u8 as *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
                                  *const libc::c_char, 434i32 as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 44],
            ...
            return &mut (*((*o).value_.gc as *mut GCUnion)).cl.l as
                       *mut LClosure as *const libc::c_void
        }
        38 => {
            if (*o).tt_ == 6i32 | 2i32 << 4i32 | 1i32 << 6i32 {
            } else {
                __assert_fail(b"((((o))->tt_) == ((((6 | (2 << 4))) | (1 << 6))))\x00"
                                  as *const u8 as *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
                                  *const libc::c_char, 435i32 as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 44],
                                                        &[libc::c_char; 44]>(b"const void *lua_topointer(lua_State *, int)\x00")).as_ptr());
            };
            if (*(*o).value_.gc).tt as libc::c_int == 6i32 | 2i32 << 4i32 {
            } else {
                __assert_fail(b"(((o)->value_).gc)->tt == (6 | (2 << 4))\x00"
                                  as *const u8 as *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
                                  *const libc::c_char, 435i32 as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 44],
            ...
            return &mut (*((*o).value_.gc as *mut GCUnion)).cl.c as
                       *mut CClosure as *const libc::c_void
        }
        22 => {
            if (*o).tt_ == 6i32 | 1i32 << 4i32 {
            } else {
                __assert_fail(b"((((o))->tt_) == ((6 | (1 << 4))))\x00" as
                                  *const u8 as *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
                                  *const libc::c_char, 436i32 as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 44],
                                                        &[libc::c_char; 44]>(b"const void *lua_topointer(lua_State *, int)\x00")).as_ptr());
            };
        ...
        8 => {
            if (*o).tt_ == 8i32 | 1i32 << 6i32 {
                ...
                __assert_fail(b"((((o))->tt_) == (((8) | (1 << 6))))\x00" as
                                  *const u8 as *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
                                  *const libc::c_char, 437i32 as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 44],
                                                        &[libc::c_char; 44]>(b"const void *lua_topointer(lua_State *, int)\x00")).as_ptr());
            };
            if (*(*o).value_.gc).tt as libc::c_int == 8i32 {
            } else {
                __assert_fail(b"(((o)->value_).gc)->tt == 8\x00" as *const u8
                                  as *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
                                  *const libc::c_char, 437i32 as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 44],
            ...
            return &mut (*((*o).value_.gc as *mut GCUnion)).th as
                       *mut lua_State as *const libc::c_void
        }
        7 => {
            if 0 != ::std::mem::size_of::<lu_byte>() as libc::c_ulong {
            } else {
        ...
        2 => {
            if (*o).tt_ == 2i32 {
                ...
                __assert_fail(b"((((o))->tt_) == (2))\x00" as *const u8 as
                                  *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
                                  *const libc::c_char, 439i32 as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 44],
                                                        &[libc::c_char; 44]>(b"const void *lua_topointer(lua_State *, int)\x00")).as_ptr());
            };
            return (*o).value_.p
...
#[no_mangle]
pub unsafe extern "C" fn lua_arith(mut L: *mut lua_State_0,
                                   mut op: libc::c_int) -> () {
    let ref mut fresh25 =
        *(*((L as
                 *mut libc::c_char).offset(-(::std::mem::size_of::<L_EXTRA>()
    ...
    *fresh25 = *fresh25 + 1;
    ...
    if op != 12i32 && op != 13i32 {
        if (2i32 as libc::c_long) <
               (*(*L).ci).func.offset_to((*L).top).expect("bad offset_to") as
                   libc::c_long &&
               !(b"not enough elements in the stack\x00" as *const u8 as
                     *const libc::c_char).is_null() {
        } else {
            __assert_fail(b"((2) < (L->top - L->ci->func)) && \"not enough elements in the stack\"\x00"
                              as *const u8 as *const libc::c_char,
                          b"lapi.c\x00" as *const u8 as *const libc::c_char,
        ...
        if (1i32 as libc::c_long) <
            ...
            __assert_fail(b"((1) < (L->top - L->ci->func)) && \"not enough elements in the stack\"\x00"
                              as *const u8 as *const libc::c_char,
                          b"lapi.c\x00" as *const u8 as *const libc::c_char,
    ...
    luaO_arith(L, op, (*L).top.offset(-2isize) as *const TValue,
...
#[no_mangle]
pub unsafe extern "C" fn lua_rawequal(mut L: *mut lua_State_0,
 ...
 -> libc::c_int {
    ...
    return if o1 != &luaO_nilobject_ as *const TValue as StkId &&
               ...
               luaV_equalobj(0 as *mut lua_State_0, o1 as *const TValue,
                             o2 as *const TValue)
           } else { 0i32 };
}
#[no_mangle]
pub unsafe extern "C" fn lua_compare(mut L: *mut lua_State_0,
                                     mut index1: libc::c_int,
                                     mut index2: libc::c_int,
                                     mut op: libc::c_int) -> libc::c_int {
    ...
    *fresh28 = *fresh28 + 1;
    ...
    if o1 != &luaO_nilobject_ as *const TValue as StkId &&
        ...
        match op {
            ...
            2 => {
                i =
                    luaV_lessequal(L, o1 as *const TValue,
                                   o2 as *const TValue)
            }
            _ => {
                if 0 != 0i32 &&
                    ...
                    __assert_fail(b"(0) && \"invalid option\"\x00" as
                                      *const u8 as *const libc::c_char,
                                  b"lapi.c\x00" as *const u8 as
                                      *const libc::c_char,
...
#[no_mangle]
pub unsafe extern "C" fn lua_pushnumber(mut L: *mut lua_State_0,
                                        mut n: lua_Number) -> () {
    let ref mut fresh34 =
        *(*((L as
                 *mut libc::c_char).offset(-(::std::mem::size_of::<L_EXTRA>()
...
#[no_mangle]
pub unsafe extern "C" fn lua_pushinteger(mut L: *mut lua_State_0,
                                         mut n: lua_Integer) -> () {
    let ref mut fresh37 =
        *(*((L as
                 *mut libc::c_char).offset(-(::std::mem::size_of::<L_EXTRA>()
...
#[no_mangle]
pub unsafe extern "C" fn lua_pushlstring(mut L: *mut lua_State_0,
...
#[no_mangle]
pub unsafe extern "C" fn lua_pushstring(mut L: *mut lua_State_0,
                                        mut s: *const libc::c_char)
 -> *const libc::c_char {
    let ref mut fresh43 =
        *(*((L as
    ...
    if s.is_null() {
        ...
        if 0 == (*io).tt_ & 1i32 << 6i32 ||
            ...
            if 0 != 0i32 {
                ...
                __assert_fail(b"0\x00" as *const u8 as *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
                                  *const libc::c_char, 499i32 as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 54],
                                                        &[libc::c_char; 54]>(b"const char *lua_pushstring(lua_State *, const char *)\x00")).as_ptr());
            };
        };
...
#[no_mangle]
pub unsafe extern "C" fn lua_pushvfstring(mut L: *mut lua_State_0,
...
#[no_mangle]
pub unsafe extern "C" fn lua_pushcclosure(mut L: *mut lua_State_0,
    ...
    *fresh49 = *fresh49 + 1;
    ...
    if n == 0i32 {
        ...
        if n <= 255i32 &&
            ...
            __assert_fail(b"(n <= 255) && \"upvalue index too large\"\x00" as
                              *const u8 as *const libc::c_char,
                          b"lapi.c\x00" as *const u8 as *const libc::c_char,
        ...
        loop  {
            ...
            let mut io1: *mut TValue =
                &mut (*cl).upvalue[n as usize] as *mut TValue;
        ...
        (*io_0).value_.gc = &mut (*(x_ as *mut GCUnion)).gc as *mut GCObject;
        ...
        if 0 == (*io_0).tt_ & 1i32 << 6i32 ||
            ...
            if 0 != 0i32 {
                ...
                __assert_fail(b"0\x00" as *const u8 as *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
                                  *const libc::c_char, 536i32 as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 55],
                                                        &[libc::c_char; 55]>(b"void lua_pushcclosure(lua_State *, lua_CFunction, int)\x00")).as_ptr());
            };
        };
...
#[no_mangle]
pub unsafe extern "C" fn lua_pushboolean(mut L: *mut lua_State_0,
                                         mut b: libc::c_int) -> () {
    let ref mut fresh53 =
        *(*((L as
                 *mut libc::c_char).offset(-(::std::mem::size_of::<L_EXTRA>()
...
#[no_mangle]
pub unsafe extern "C" fn lua_pushlightuserdata(mut L: *mut lua_State_0,
...
#[no_mangle]
pub unsafe extern "C" fn lua_pushthread(mut L: *mut lua_State_0)
 -> libc::c_int {
    let ref mut fresh59 =
        *(*((L as
                 *mut libc::c_char).offset(-(::std::mem::size_of::<L_EXTRA>()
...
#[no_mangle]
pub unsafe extern "C" fn lua_getglobal(mut L: *mut lua_State_0,
 ...
 -> libc::c_int {
    ...
    let mut reg: *mut Table_0 =
        &mut (*((*(*L).l_G).l_registry.value_.gc as *mut GCUnion)).h as
            *mut Table;
    let ref mut fresh62 =
        *(*((L as
                 *mut libc::c_char).offset(-(::std::mem::size_of::<L_EXTRA>()
...
unsafe extern "C" fn auxgetstr(mut L: *mut lua_State_0, mut t: *const TValue,
                               mut k: *const libc::c_char) -> libc::c_int {
    ...
    if 0 !=
           if !((*t).tt_ == 5i32 | 1i32 << 6i32) {
               ...
               slot =
                   luaH_getstr(&mut (*((*t).value_.gc as *mut GCUnion)).h,
                               str);
        ...
        *io1 = *slot;
        ...
        if 0 == (*io).tt_ & 1i32 << 6i32 ||
            ...
            if 0 != 0i32 {
                ...
                __assert_fail(b"0\x00" as *const u8 as *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
                                  *const libc::c_char, 583i32 as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 57],
                                                        &[libc::c_char; 57]>(b"int auxgetstr(lua_State *, const TValue *, const char *)\x00")).as_ptr());
            };
        };
        ...
        luaV_finishget(L, t, (*L).top.offset(-1isize),
                       (*L).top.offset(-1isize), slot);
    }
    let ref mut fresh64 =
        *(*((L as
                 *mut libc::c_char).offset(-(::std::mem::size_of::<L_EXTRA>()
    ...
    *fresh64 -= 1;
    ...
    return (*(*L).top.offset(-1isize)).tt_ & 15i32;
}
#[no_mangle]
pub unsafe extern "C" fn lua_gettable(mut L: *mut lua_State_0,
                                      mut idx: libc::c_int) -> libc::c_int {
    let mut t: StkId = 0 as *mut TValue;
    let ref mut fresh65 =
        *(*((L as
    ...
    *fresh65 = *fresh65 + 1;
    ...
    if 0 !=
           if !((*t).tt_ == 5i32 | 1i32 << 6i32) {
               ...
               slot =
                   luaH_get(&mut (*((*t).value_.gc as *mut GCUnion)).h,
                            (*L).top.offset(-1isize) as *const TValue);
               !((*slot).tt_ == 0i32) as libc::c_int
           } {
        ...
        *io1 = *slot;
        if 0 == (*io1).tt_ & 1i32 << 6i32 ||
            ...
            if 0 != 0i32 {
                ...
                __assert_fail(b"0\x00" as *const u8 as *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
                                  *const libc::c_char, 603i32 as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 35],
                                                        &[libc::c_char; 35]>(b"int lua_gettable(lua_State *, int)\x00")).as_ptr());
            };
        };
    } else {
        luaV_finishget(L, t as *const TValue, (*L).top.offset(-1isize),
                       (*L).top.offset(-1isize), slot);
    }
    let ref mut fresh67 =
        *(*((L as
...
#[no_mangle]
pub unsafe extern "C" fn lua_getfield(mut L: *mut lua_State_0,
                                      mut idx: libc::c_int,
...
#[no_mangle]
pub unsafe extern "C" fn lua_geti(mut L: *mut lua_State_0,
                                  mut idx: libc::c_int, mut n: lua_Integer)
 -> libc::c_int {
    let mut t: StkId = 0 as *mut TValue;
    let mut slot: *const TValue = 0 as *const TValue;
    let ref mut fresh70 =
        ...
        *io1 = *slot;
        if 0 == (*io1).tt_ & 1i32 << 6i32 ||
            ...
            if 0 != 0i32 {
                ...
                __assert_fail(b"0\x00" as *const u8 as *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
                                  *const libc::c_char, 621i32 as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 44],
                                                        &[libc::c_char; 44]>(b"int lua_geti(lua_State *, int, lua_Integer)\x00")).as_ptr());
            };
        };
...
#[no_mangle]
pub unsafe extern "C" fn lua_rawget(mut L: *mut lua_State_0,
                                    mut idx: libc::c_int) -> libc::c_int {
    let mut t: StkId = 0 as *mut TValue;
    let ref mut fresh73 =
        *(*((L as
    ...
    *fresh73 = *fresh73 + 1;
    ...
    t = index2addr(L, idx);
    if (*t).tt_ == 5i32 | 1i32 << 6i32 &&
           !(b"table expected\x00" as *const u8 as
                 *const libc::c_char).is_null() {
    } else {
        __assert_fail(b"(((((t))->tt_) == (((5) | (1 << 6))))) && \"table expected\"\x00"
                          as *const u8 as *const libc::c_char,
                      b"lapi.c\x00" as *const u8 as *const libc::c_char,
    ...
    if (*t).tt_ == 5i32 | 1i32 << 6i32 {
        ...
        __assert_fail(b"((((t))->tt_) == (((5) | (1 << 6))))\x00" as *const u8
                          as *const libc::c_char,
                      b"lapi.c\x00" as *const u8 as *const libc::c_char,
    ...
    if (*(*t).value_.gc).tt as libc::c_int == 5i32 {
        ...
        __assert_fail(b"(((t)->value_).gc)->tt == 5\x00" as *const u8 as
                          *const libc::c_char,
                      b"lapi.c\x00" as *const u8 as *const libc::c_char,
                      639i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 33],
...
#[no_mangle]
pub unsafe extern "C" fn lua_rawgeti(mut L: *mut lua_State_0,
                                     mut idx: libc::c_int, mut n: lua_Integer)
 -> libc::c_int {
    let mut t: StkId = 0 as *mut TValue;
    let ref mut fresh76 =
...
#[no_mangle]
pub unsafe extern "C" fn lua_rawgetp(mut L: *mut lua_State_0,
                                     mut idx: libc::c_int,
...
#[no_mangle]
pub unsafe extern "C" fn lua_createtable(mut L: *mut lua_State_0,
...
#[no_mangle]
pub unsafe extern "C" fn lua_newuserdata(mut L: *mut lua_State_0,
                                         mut size: size_t)
 -> *mut libc::c_void {
    ...
    *fresh87 -= 1;
    ...
    if 0 != ::std::mem::size_of::<lu_byte>() as libc::c_ulong {
        ...
        __assert_fail(b"sizeof((u)->ttuv_)\x00" as *const u8 as
                          *const libc::c_char,
                      b"lapi.c\x00" as *const u8 as *const libc::c_char,
    ...
    return (u as
                *mut libc::c_char).offset(::std::mem::size_of::<UUdata>() as
                                              libc::c_ulong as isize) as
               *mut libc::c_void;
}
#[no_mangle]
pub unsafe extern "C" fn lua_getmetatable(mut L: *mut lua_State_0,
    ...
    match (*obj).tt_ & 15i32 {
        5 => {
            if (*obj).tt_ == 5i32 | 1i32 << 6i32 {
                ...
                __assert_fail(b"((((obj))->tt_) == (((5) | (1 << 6))))\x00" as
                                  *const u8 as *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
                                  *const libc::c_char, 692i32 as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 39],
                                                        &[libc::c_char; 39]>(b"int lua_getmetatable(lua_State *, int)\x00")).as_ptr());
            };
            if (*(*obj).value_.gc).tt as libc::c_int == 5i32 {
            } else {
                __assert_fail(b"(((obj)->value_).gc)->tt == 5\x00" as
                                  *const u8 as *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
                                  *const libc::c_char, 692i32 as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 39],
            ...
            mt =
                (*(&mut (*((*obj).value_.gc as *mut GCUnion)).h as
                       *mut Table)).metatable
        }
        7 => {
            if (*obj).tt_ == 7i32 | 1i32 << 6i32 {
            } else {
                __assert_fail(b"((((obj))->tt_) == (((7) | (1 << 6))))\x00" as
                                  *const u8 as *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
                                  *const libc::c_char, 695i32 as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 39],
                                                        &[libc::c_char; 39]>(b"int lua_getmetatable(lua_State *, int)\x00")).as_ptr());
            };
            if (*(*obj).value_.gc).tt as libc::c_int == 7i32 {
            } else {
                __assert_fail(b"(((obj)->value_).gc)->tt == 7\x00" as
                                  *const u8 as *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
                                  *const libc::c_char, 695i32 as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 39],
            ...
            mt =
                (*(&mut (*((*obj).value_.gc as *mut GCUnion)).u as
                       *mut Udata)).metatable
        }
        _ => { mt = (*(*L).l_G).mt[((*obj).tt_ & 15i32) as usize] }
    }
    if !mt.is_null() {
        let mut io: *mut TValue = (*L).top;
        ...
        if 0 == (*io).tt_ & 1i32 << 6i32 ||
            ...
            if 0 != 0i32 {
                ...
                __assert_fail(b"0\x00" as *const u8 as *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
                                  *const libc::c_char, 702i32 as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 39],
                                                        &[libc::c_char; 39]>(b"int lua_getmetatable(lua_State *, int)\x00")).as_ptr());
            };
        };
...
#[no_mangle]
pub unsafe extern "C" fn lua_getuservalue(mut L: *mut lua_State_0,
                                          mut idx: libc::c_int)
 -> libc::c_int {
    ...
    *fresh91 = *fresh91 + 1;
    ...
    o = index2addr(L, idx);
    if (*o).tt_ == 7i32 | 1i32 << 6i32 &&
           !(b"full userdata expected\x00" as *const u8 as
                 *const libc::c_char).is_null() {
    } else {
        __assert_fail(b"(((((o))->tt_) == (((7) | (1 << 6))))) && \"full userdata expected\"\x00"
                          as *const u8 as *const libc::c_char,
                      b"lapi.c\x00" as *const u8 as *const libc::c_char,
    ...
    if (*o).tt_ == 7i32 | 1i32 << 6i32 {
        ...
        __assert_fail(b"((((o))->tt_) == (((7) | (1 << 6))))\x00" as *const u8
                          as *const libc::c_char,
                      b"lapi.c\x00" as *const u8 as *const libc::c_char,
    ...
    if (*(*o).value_.gc).tt as libc::c_int == 7i32 {
        ...
        __assert_fail(b"(((o)->value_).gc)->tt == 7\x00" as *const u8 as
                          *const libc::c_char,
                      b"lapi.c\x00" as *const u8 as *const libc::c_char,
                      716i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 39],
...
#[no_mangle]
pub unsafe extern "C" fn lua_setglobal(mut L: *mut lua_State_0,
                                       mut name: *const libc::c_char) -> () {
    if (*(*L).l_G).l_registry.tt_ == 5i32 | 1i32 << 6i32 {
    } else {
        __assert_fail(b"((((&(L->l_G)->l_registry))->tt_) == (((5) | (1 << 6))))\x00"
...
unsafe extern "C" fn auxsetstr(mut L: *mut lua_State_0, mut t: *const TValue,
                               mut k: *const libc::c_char) -> () {
    let mut slot: *const TValue = 0 as *const TValue;
    let mut str: *mut TString = luaS_new(L, k);
    if (1i32 as libc::c_long) <
    ...
    if 0 !=
                   ...
                   if 0 != (*(*L).top.offset(-1isize)).tt_ & 1i32 << 6i32 &&
                          {
                              ...
                              0 !=
                                  (*(&mut (*((*t).value_.gc as
                                                 *mut GCUnion)).h as
                                         *mut Table)).marked as libc::c_int &
                                      1i32 << 2i32
                          } &&
                          {
                              if 0 !=
                                     (*(*L).top.offset(-1isize)).tt_ &
                                         1i32 << 6i32 {
                              } else {
                                  __assert_fail(b"(((L->top - 1)->tt_) & (1 << 6))\x00"
                                                    as *const u8 as
                                                    *const libc::c_char,
                                                b"lapi.c\x00" as *const u8 as
                                                    *const libc::c_char,
                              ...
                              0 !=
                                  (*(*(*L).top.offset(-1isize)).value_.gc).marked
                                      as libc::c_int &
                                      (1i32 << 0i32 | 1i32 << 1i32)
                          } {
                       if (*t).tt_ == 5i32 | 1i32 << 6i32 {
        ...
        if 0 == (*io).tt_ & 1i32 << 6i32 ||
            ...
            if 0 != 0i32 {
                ...
                __assert_fail(b"0\x00" as *const u8 as *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
                                  *const libc::c_char, 737i32 as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 58],
                                                        &[libc::c_char; 58]>(b"void auxsetstr(lua_State *, const TValue *, const char *)\x00")).as_ptr());
            };
        };
        ...
        luaV_finishset(L, t, (*L).top.offset(-1isize),
                       (*L).top.offset(-2isize), slot);
...
#[no_mangle]
pub unsafe extern "C" fn lua_settable(mut L: *mut lua_State_0,
                                      mut idx: libc::c_int) -> () {
    let mut t: StkId = 0 as *mut TValue;
    let ref mut fresh97 =
        *(*((L as
    ...
    *fresh97 = *fresh97 + 1;
    ...
    if 0 ==
        ...
        luaV_finishset(L, t as *const TValue, (*L).top.offset(-2isize),
                       (*L).top.offset(-1isize), slot);
    }
    (*L).top = (*L).top.offset(-2isize);
    let ref mut fresh99 =
...
#[no_mangle]
pub unsafe extern "C" fn lua_setfield(mut L: *mut lua_State_0,
                                      mut idx: libc::c_int,
                                      mut k: *const libc::c_char) -> () {
...
#[no_mangle]
pub unsafe extern "C" fn lua_seti(mut L: *mut lua_State_0,
                                  mut idx: libc::c_int, mut n: lua_Integer)
 -> () {
    let mut t: StkId = 0 as *mut TValue;
    let mut slot: *const TValue = 0 as *const TValue;
    ...
    *fresh102 = *fresh102 + 1;
    ...
    if 0 !=
        ...
        luaV_finishset(L, t as *const TValue, (*L).top.offset(-1isize),
                       (*L).top.offset(-2isize), slot);
        (*L).top = (*L).top.offset(-2isize)
    }
...
#[no_mangle]
pub unsafe extern "C" fn lua_rawset(mut L: *mut lua_State_0,
                                    mut idx: libc::c_int) -> () {
    let mut o: StkId = 0 as *mut TValue;
    ...
    *fresh105 = *fresh105 + 1;
    ...
    if (*o).tt_ == 5i32 | 1i32 << 6i32 &&
        ...
        __assert_fail(b"(((((o))->tt_) == (((5) | (1 << 6))))) && \"table expected\"\x00"
                          as *const u8 as *const libc::c_char,
                      b"lapi.c\x00" as *const u8 as *const libc::c_char,
    ...
    if (*o).tt_ == 5i32 | 1i32 << 6i32 {
        ...
        __assert_fail(b"((((o))->tt_) == (((5) | (1 << 6))))\x00" as *const u8
                          as *const libc::c_char,
                      b"lapi.c\x00" as *const u8 as *const libc::c_char,
    ...
    if (*(*o).value_.gc).tt as libc::c_int == 5i32 {
        ...
        __assert_fail(b"(((o)->value_).gc)->tt == 5\x00" as *const u8 as
                          *const libc::c_char,
                      b"lapi.c\x00" as *const u8 as *const libc::c_char,
                      795i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 34],
    ...
    slot =
        luaH_set(L, &mut (*((*o).value_.gc as *mut GCUnion)).h,
                 (*L).top.offset(-2isize) as *const TValue);
    *slot = *(*L).top.offset(-1isize);
    if 0 == (*slot).tt_ & 1i32 << 6i32 ||
           {
               if 0 != (*slot).tt_ & 1i32 << 6i32 {
                   ...
                   __assert_fail(b"((((slot))->tt_) & (1 << 6))\x00" as
                                     *const u8 as *const libc::c_char,
                                 b"lapi.c\x00" as *const u8 as
                                     *const libc::c_char,
               ...
               (*slot).tt_ & 63i32 == (*(*slot).value_.gc).tt as libc::c_int
                   &&
                   (L.is_null() ||
                        {
                            if 0 != (*slot).tt_ & 1i32 << 6i32 {
                            } else {
                                __assert_fail(b"((((slot))->tt_) & (1 << 6))\x00"
                                                  as *const u8 as
                                                  *const libc::c_char,
                                              b"lapi.c\x00" as *const u8 as
                                                  *const libc::c_char,
    ...
    (*(&mut (*((*o).value_.gc as *mut GCUnion)).h as *mut Table)).flags =
        0i32 as lu_byte;
    if 0 != (*(*L).top.offset(-1isize)).tt_ & 1i32 << 6i32 &&
           {
               if (*o).tt_ == 5i32 | 1i32 << 6i32 {
               } else {
                   __assert_fail(b"((((o))->tt_) == (((5) | (1 << 6))))\x00"
                                     as *const u8 as *const libc::c_char,
                                 b"lapi.c\x00" as *const u8 as
                                     *const libc::c_char,
               ...
               if (*(*o).value_.gc).tt as libc::c_int == 5i32 {
                   ...
                   __assert_fail(b"(((o)->value_).gc)->tt == 5\x00" as
                                     *const u8 as *const libc::c_char,
                                 b"lapi.c\x00" as *const u8 as
                                     *const libc::c_char,
                                 798i32 as libc::c_uint,
               ...
               0 !=
                   (*(&mut (*((*o).value_.gc as *mut GCUnion)).h as
                          *mut Table)).marked as libc::c_int & 1i32 << 2i32
           } &&
           {
               if 0 != (*(*L).top.offset(-1isize)).tt_ & 1i32 << 6i32 {
               } else {
                   __assert_fail(b"(((L->top-1)->tt_) & (1 << 6))\x00" as
                                     *const u8 as *const libc::c_char,
                                 b"lapi.c\x00" as *const u8 as
                                     *const libc::c_char,
                                 798i32 as libc::c_uint,
               ...
               0 !=
                   (*(*(*L).top.offset(-1isize)).value_.gc).marked as
...
#[no_mangle]
pub unsafe extern "C" fn lua_rawseti(mut L: *mut lua_State_0,
                                     mut idx: libc::c_int, mut n: lua_Integer)
 -> () {
    let mut o: StkId = 0 as *mut TValue;
    ...
    *fresh108 = *fresh108 + 1;
    ...
    luaH_setint(L, &mut (*((*o).value_.gc as *mut GCUnion)).h, n,
                (*L).top.offset(-1isize));
    if 0 != (*(*L).top.offset(-1isize)).tt_ & 1i32 << 6i32 &&
           {
               if (*o).tt_ == 5i32 | 1i32 << 6i32 {
...
#[no_mangle]
pub unsafe extern "C" fn lua_rawsetp(mut L: *mut lua_State_0,
                                     mut idx: libc::c_int,
                                     mut p: *const libc::c_void) -> () {
    let mut o: StkId = 0 as *mut TValue;
    let mut k: TValue =
...
#[no_mangle]
pub unsafe extern "C" fn lua_setmetatable(mut L: *mut lua_State_0,
                                          mut objindex: libc::c_int)
 -> libc::c_int {
    ...
    *fresh114 = *fresh114 + 1;
    ...
    if (*(*L).top.offset(-1isize)).tt_ == 0i32 {
        ...
        if (*(*L).top.offset(-1isize)).tt_ == 5i32 | 1i32 << 6i32 &&
            ...
            __assert_fail(b"(((((L->top - 1))->tt_) == (((5) | (1 << 6))))) && \"table expected\"\x00"
                              as *const u8 as *const libc::c_char,
                          b"lapi.c\x00" as *const u8 as *const libc::c_char,
        ...
        if (*(*L).top.offset(-1isize)).tt_ == 5i32 | 1i32 << 6i32 {
            ...
            __assert_fail(b"((((L->top - 1))->tt_) == (((5) | (1 << 6))))\x00"
                              as *const u8 as *const libc::c_char,
                          b"lapi.c\x00" as *const u8 as *const libc::c_char,
        ...
        if (*(*(*L).top.offset(-1isize)).value_.gc).tt as libc::c_int == 5i32
           {
            ...
            __assert_fail(b"(((L->top - 1)->value_).gc)->tt == 5\x00" as
                              *const u8 as *const libc::c_char,
                          b"lapi.c\x00" as *const u8 as *const libc::c_char,
                          843i32 as libc::c_uint,
                          (*::std::mem::transmute::<&[u8; 39],
        ...
        mt =
            &mut (*((*(*L).top.offset(-1isize)).value_.gc as *mut GCUnion)).h
                as *mut Table
    }
    match (*obj).tt_ & 15i32 {
        5 => {
            if (*obj).tt_ == 5i32 | 1i32 << 6i32 {
                ...
                __assert_fail(b"((((obj))->tt_) == (((5) | (1 << 6))))\x00" as
                                  *const u8 as *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
                                  *const libc::c_char, 847i32 as libc::c_uint,
                              (*::std::mem::transmute::<&[u8; 39],
                                                        &[libc::c_char; 39]>(b"int lua_setmetatable(lua_State *, int)\x00")).as_ptr());
            };
            if (*(*obj).value_.gc).tt as libc::c_int == 5i32 {
            ...
            *fresh116 = mt;
            if !mt.is_null() {
                if 0 != (*obj).tt_ & 1i32 << 6i32 {
                    ...
                    __assert_fail(b"(((obj)->tt_) & (1 << 6))\x00" as
                                      *const u8 as *const libc::c_char,
                                  b"lapi.c\x00" as *const u8 as
                                      *const libc::c_char,
                ...
                if 0 !=
                       (*(*obj).value_.gc).marked as libc::c_int &
                           1i32 << 2i32 &&
                       0 !=
            ...
            *fresh117 = mt;
            if !mt.is_null() {
                if (*obj).tt_ == 7i32 | 1i32 << 6i32 {
                    ...
                    __assert_fail(b"((((obj))->tt_) == (((7) | (1 << 6))))\x00"
                                      as *const u8 as *const libc::c_char,
                                  b"lapi.c\x00" as *const u8 as
                                      *const libc::c_char,
                ...
                if 0 !=
                       (*(&mut (*((*obj).value_.gc as *mut GCUnion)).u as
                              *mut Udata)).marked as libc::c_int &
                           1i32 << 2i32 &&
                       0 !=
                           (*mt).marked as libc::c_int &
                               (1i32 << 0i32 | 1i32 << 1i32) {
                    ...
                    if (*(&mut (*((*obj).value_.gc as *mut GCUnion)).u as
                              *mut Udata)).tt as libc::c_int & 15i32 <
                           9i32 + 1i32 {
                    } else {
                    ...
                    luaC_barrier_(L,
                                  &mut (*(&mut (*((*obj).value_.gc as
                                                      *mut GCUnion)).u as
                                              *mut Udata as *mut GCUnion)).gc,
                                  &mut (*(mt as *mut GCUnion)).gc);
                } else { };
                if 0 != (*obj).tt_ & 1i32 << 6i32 {
                } else {
        ...
        _ => { (*(*L).l_G).mt[((*obj).tt_ & 15i32) as usize] = mt }
    }
    (*L).top = (*L).top.offset(-1isize);
...
#[no_mangle]
pub unsafe extern "C" fn lua_setuservalue(mut L: *mut lua_State_0,
                                          mut idx: libc::c_int) -> () {
    let mut o: StkId = 0 as *mut TValue;
    ...
    *fresh119 = *fresh119 + 1;
    ...
    if 0 != (*(*L).top.offset(-1isize)).tt_ & 1i32 << 6i32 &&
        ...
        if (*(*o).value_.gc).tt as libc::c_int & 15i32 < 9i32 + 1i32 {
        } else {
        ...
        if 0 != (*(*L).top.offset(-1isize)).tt_ & 1i32 << 6i32 {
            ...
            __assert_fail(b"(((L->top - 1)->tt_) & (1 << 6))\x00" as *const u8
                              as *const libc::c_char,
                          b"lapi.c\x00" as *const u8 as *const libc::c_char,
                          880i32 as libc::c_uint,
                          (*::std::mem::transmute::<&[u8; 40],
        ...
        luaC_barrier_(L, &mut (*((*o).value_.gc as *mut GCUnion)).gc,
...
#[no_mangle]
pub unsafe extern "C" fn lua_callk(mut L: *mut lua_State_0,
    ...
    *fresh122 = *fresh122 + 1;
    ...
    if (k.is_none() ||
            0 == (*(*L).ci).callstatus as libc::c_int & 1i32 << 1i32) &&
           !(b"cannot use continuations inside hooks\x00" as *const u8 as
                 *const libc::c_char).is_null() {
    } else {
    ...
    if ((nargs + 1i32) as libc::c_long) <
        ...
        __assert_fail(b"((nargs+1) < (L->top - L->ci->func)) && \"not enough elements in the stack\"\x00"
                          as *const u8 as *const libc::c_char,
                      b"lapi.c\x00" as *const u8 as *const libc::c_char,
    ...
    if (*L).status as libc::c_int == 0i32 &&
           !(b"cannot do calls on non-normal thread\x00" as *const u8 as
                 *const libc::c_char).is_null() {
    } else {
        __assert_fail(b"(L->status == 0) && \"cannot do calls on non-normal thread\"\x00"
                          as *const u8 as *const libc::c_char,
                      b"lapi.c\x00" as *const u8 as *const libc::c_char,
    ...
    if (nresults == -1i32 ||
            (*L).top.offset_to((*(*L).ci).top).expect("bad offset_to") as
                libc::c_long >= (nresults - nargs) as libc::c_long) &&
           !(b"results from function overflow current stack size\x00" as
    ...
    } else { luaD_callnoyield(L, func, nresults); }
...
#[no_mangle]
pub unsafe extern "C" fn lua_pcallk(mut L: *mut lua_State_0,
                                    mut nargs: libc::c_int,
                                    mut nresults: libc::c_int,
    ...
    let mut o: StkId = 0 as *mut TValue;
    let mut c: CallS = CallS{func: 0 as *mut TValue, nresults: 0,};
    ...
    *fresh125 = *fresh125 + 1;
    ...
    if errfunc == 0i32 {
        ...
        func =
            ((*L).stack as
                 *mut libc::c_char).offset_to(o as
    ...
    if k.is_none() || (*L).nny as libc::c_int > 0i32 {
        c.nresults = nresults;
        status =
            luaD_pcall(L, Some(f_call),
                       &mut c as *mut CallS as *mut libc::c_void,
                       ((*L).stack as
                            *mut libc::c_char).offset_to(c.func as
                                                             *mut libc::c_char).expect("bad offset_to")
                           as libc::c_long, func)
    } else {
        ci = (*L).ci;
        ...
        (*L).errfunc = func;
        (*ci).callstatus =
            ((*ci).callstatus as libc::c_int & !(1i32 << 0i32) |
...
unsafe extern "C" fn f_call(mut L: *mut lua_State_0,
                            mut ud: *mut libc::c_void) -> () {
    let mut c: *mut CallS = ud as *mut CallS;
    luaD_callnoyield(L, (*c).func, (*c).nresults);
}
#[no_mangle]
pub unsafe extern "C" fn lua_load(mut L: *mut lua_State_0,
 ...
 -> libc::c_int {
    ...
    *fresh128 = *fresh128 + 1;
    ...
    if status == 0i32 {
        ...
        let mut f: *mut LClosure =
            &mut (*((*(*L).top.offset(-1isize)).value_.gc as
                        *mut GCUnion)).cl.l as *mut LClosure;
        if (*f).nupvalues as libc::c_int >= 1i32 {
            ...
            *io1 = *gt;
            ...
            if 0 != (*(*(*f).upvals[0usize]).v).tt_ & 1i32 << 6i32 &&
                   !((*(*f).upvals[0usize]).v !=
                         &mut (*(*f).upvals[0usize]).u.value as *mut TValue) {
...
#[no_mangle]
pub unsafe extern "C" fn lua_dump(mut L: *mut lua_State_0,
    ...
    *fresh131 = *fresh131 + 1;
    ...
    if (*o).tt_ == 6i32 | 0i32 << 4i32 | 1i32 << 6i32 {
        ...
        if (*(*o).value_.gc).tt as libc::c_int == 6i32 | 0i32 << 4i32 {
            ...
            __assert_fail(b"(((o)->value_).gc)->tt == (6 | (0 << 4))\x00" as
                              *const u8 as *const libc::c_char,
                          b"lapi.c\x00" as *const u8 as *const libc::c_char,
                          1010i32 as libc::c_uint,
                          (*::std::mem::transmute::<&[u8; 51],
        ...
        status =
            luaU_dump(L, (*&mut (*((*o).value_.gc as *mut GCUnion)).cl.l).p,
                      writer, data, strip)
    } else { status = 1i32 }
...
#[no_mangle]
pub unsafe extern "C" fn lua_gc(mut L: *mut lua_State_0,
                                mut what: libc::c_int, mut data: libc::c_int)
 -> libc::c_int {
    let mut res: libc::c_int = 0i32;
    ...
    *fresh134 = *fresh134 + 1;
    ...
    match what {
        ...
        2 => { luaC_fullgc(L, 0i32); }
        3 => {
            res =
                (((*g).totalbytes + (*g).GCdebt) as lu_mem >> 10i32) as
                    libc::c_int
        }
        4 => {
            res =
                (((*g).totalbytes + (*g).GCdebt) as lu_mem &
                     1023i32 as libc::c_ulong) as libc::c_int
        }
        5 => {
        ...
        6 => { res = (*g).gcpause; (*g).gcpause = data }
        7 => {
            res = (*g).gcstepmul;
            if data < 40i32 { data = 40i32 }
            (*g).gcstepmul = data
        }
...
#[no_mangle]
pub unsafe extern "C" fn lua_next(mut L: *mut lua_State_0,
                                  mut idx: libc::c_int) -> libc::c_int {
    let mut t: StkId = 0 as *mut TValue;
    ...
    *fresh139 = *fresh139 + 1;
    ...
    more =
        luaH_next(L, &mut (*((*t).value_.gc as *mut GCUnion)).h,
                  (*L).top.offset(-1isize));
    if 0 != more {
        (*L).top = (*L).top.offset(1isize);
        if (*L).top <= (*(*L).ci).top &&
    ...
    } else { (*L).top = (*L).top.offset(-1isize) }
...
#[no_mangle]
pub unsafe extern "C" fn lua_concat(mut L: *mut lua_State_0,
                                    mut n: libc::c_int) -> () {
    ...
    *fresh142 = *fresh142 + 1;
    ...
    if n >= 2i32 {
        ...
        let mut x_: *mut TString =
            luaS_newlstr(L, b"\x00" as *const u8 as *const libc::c_char,
                         0i32 as size_t);
        if (*x_).tt as libc::c_int & 15i32 < 9i32 + 1i32 {
        } else {
            __assert_fail(b"(((x_)->tt) & 0x0F) < (9+1)\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn lua_len(mut L: *mut lua_State_0,
                                 mut idx: libc::c_int) -> () {
    let mut t: StkId = 0 as *mut TValue;
...
#[no_mangle]
pub unsafe extern "C" fn lua_stringtonumber(mut L: *mut lua_State_0,
                                            mut s: *const libc::c_char)
 -> size_t {
        ...
        if (*L).top <= (*(*L).ci).top &&
            ...
            __assert_fail(b"(L->top <= L->ci->top) && \"stack overflow\"\x00"
                          ...
                          (*::std::mem::transmute::<&[u8; 53],
                                                    &[libc::c_char; 53]>(b"size_t lua_stringtonumber(lua_State *, const char *)\x00")).as_ptr());
        };
    }
    return sz;
}
#[no_mangle]
pub unsafe extern "C" fn lua_getallocf(mut L: *mut lua_State_0,
...
#[no_mangle]
pub unsafe extern "C" fn lua_setallocf(mut L: *mut lua_State_0,
                                       mut f: lua_Alloc,
                                       mut ud: *mut libc::c_void) -> () {
...
#[no_mangle]
pub unsafe extern "C" fn lua_getupvalue(mut L: *mut lua_State_0,
 ...
 -> *const libc::c_char {
    ...
    *fresh154 = *fresh154 + 1;
    ...
    name =
        aux_upvalue(index2addr(L, funcindex), n, &mut val,
                    0 as *mut *mut CClosure, 0 as *mut *mut UpVal);
    if !name.is_null() {
        let mut io1: *mut TValue = (*L).top;
        *io1 = *val;
        if 0 == (*io1).tt_ & 1i32 << 6i32 ||
...
unsafe extern "C" fn aux_upvalue(mut fi: StkId, mut n: libc::c_int,
 ...
 -> *const libc::c_char {
    match (*fi).tt_ & 63i32 {
        38 => {
            ...
            let mut f: *mut CClosure =
                &mut (*((*fi).value_.gc as *mut GCUnion)).cl.c as
                    *mut CClosure;
            if !(1i32 <= n && n <= (*f).nupvalues as libc::c_int) {
                return 0 as *const libc::c_char
            } else {
                *val = &mut (*f).upvalue[(n - 1i32) as usize] as *mut TValue;
                if !owner.is_null() { *owner = f }
        ...
        6 => {
            ...
            let mut f_0: *mut LClosure =
                &mut (*((*fi).value_.gc as *mut GCUnion)).cl.l as
                    *mut LClosure;
            ...
            if !(1i32 <= n && n <= (*p).sizeupvalues) {
                ...
                *val = (*(*f_0).upvals[(n - 1i32) as usize]).v;
                if !uv.is_null() { *uv = (*f_0).upvals[(n - 1i32) as usize] }
...
#[no_mangle]
pub unsafe extern "C" fn lua_setupvalue(mut L: *mut lua_State_0,
                                        mut funcindex: libc::c_int,
                                        mut n: libc::c_int)
 -> *const libc::c_char {
    let mut name: *const libc::c_char = 0 as *const libc::c_char;
            ...
            if 0 != (*(*L).top).tt_ & 1i32 << 6i32 &&
                   0 != (*owner).marked as libc::c_int & 1i32 << 2i32 &&
                   {
                       if 0 != (*(*L).top).tt_ & 1i32 << 6i32 {
                           ...
                           __assert_fail(b"(((L->top)->tt_) & (1 << 6))\x00"
                                             as *const u8 as
                                             *const libc::c_char,
                                         b"lapi.c\x00" as *const u8 as
                                             *const libc::c_char,
                ...
                if (*owner).tt as libc::c_int & 15i32 < 9i32 + 1i32 {
                } else {
                    __assert_fail(b"(((owner)->tt) & 0x0F) < (9+1)\x00" as
                                      *const u8 as *const libc::c_char,
                                  b"lapi.c\x00" as *const u8 as
                                      *const libc::c_char,
                                  1236i32 as libc::c_uint,
                ...
                if 0 != (*(*L).top).tt_ & 1i32 << 6i32 {
                    ...
                    __assert_fail(b"(((L->top)->tt_) & (1 << 6))\x00" as
                                      *const u8 as *const libc::c_char,
                                  b"lapi.c\x00" as *const u8 as
                                      *const libc::c_char,
                                  1236i32 as libc::c_uint,
                ...
                luaC_barrier_(L, &mut (*(owner as *mut GCUnion)).gc,
                              (*(*L).top).value_.gc);
            } else { };
        } else if !uv.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn lua_upvalueid(mut L: *mut lua_State_0,
                                       mut fidx: libc::c_int,
                                       mut n: libc::c_int)
 -> *mut libc::c_void {
    ...
    match (*fi).tt_ & 63i32 {
        6 => {
            return *getupvalref(L, fidx, n, 0 as *mut *mut LClosure) as
                       *mut libc::c_void
        }
        38 => {
            if (*fi).tt_ == 6i32 | 2i32 << 4i32 | 1i32 << 6i32 {
                ...
                __assert_fail(b"((((fi))->tt_) == ((((6 | (2 << 4))) | (1 << 6))))\x00"
                              ...
                              (*::std::mem::transmute::<&[u8; 43],
                                                        &[libc::c_char; 43]>(b"void *lua_upvalueid(lua_State *, int, int)\x00")).as_ptr());
            };
            if (*(*fi).value_.gc).tt as libc::c_int == 6i32 | 2i32 << 4i32 {
            } else {
                __assert_fail(b"(((fi)->value_).gc)->tt == (6 | (2 << 4))\x00"
            ...
            let mut f: *mut CClosure =
                &mut (*((*fi).value_.gc as *mut GCUnion)).cl.c as
                    *mut CClosure;
            if 1i32 <= n && n <= (*f).nupvalues as libc::c_int &&
                   !(b"invalid upvalue index\x00" as *const u8 as
                         *const libc::c_char).is_null() {
            } else {
                __assert_fail(b"(1 <= n && n <= f->nupvalues) && \"invalid upvalue index\"\x00"
                                  as *const u8 as *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
                                  *const libc::c_char,
            ...
            return &mut (*f).upvalue[(n - 1i32) as usize] as *mut TValue as
                       *mut libc::c_void
        }
        _ => {
            if 0 != 0i32 &&
                   !(b"closure expected\x00" as *const u8 as
                         *const libc::c_char).is_null() {
            } else {
                __assert_fail(b"(0) && \"closure expected\"\x00" as *const u8
                                  as *const libc::c_char,
                              b"lapi.c\x00" as *const u8 as
                                  *const libc::c_char,
...
unsafe extern "C" fn getupvalref(mut L: *mut lua_State_0,
                                 mut fidx: libc::c_int, mut n: libc::c_int,
                                 mut pf: *mut *mut LClosure)
 -> *mut *mut UpVal {
    let mut f: *mut LClosure = 0 as *mut LClosure;
    let mut fi: StkId = index2addr(L, fidx);
    if (*fi).tt_ == 6i32 | 0i32 << 4i32 | 1i32 << 6i32 &&
           !(b"Lua function expected\x00" as *const u8 as
                 *const libc::c_char).is_null() {
    } else {
        __assert_fail(b"(((((fi))->tt_) == ((((6 | (0 << 4))) | (1 << 6))))) && \"Lua function expected\"\x00"
                          as *const u8 as *const libc::c_char,
                      b"lapi.c\x00" as *const u8 as *const libc::c_char,
                      1247i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 56],
                                                &[libc::c_char; 56]>(b"UpVal **getupvalref(lua_State *, int, int, LClosure **)\x00")).as_ptr());
    };
    if (*fi).tt_ == 6i32 | 0i32 << 4i32 | 1i32 << 6i32 {
    } else {
        __assert_fail(b"((((fi))->tt_) == ((((6 | (0 << 4))) | (1 << 6))))\x00"
    ...
    if (*(*fi).value_.gc).tt as libc::c_int == 6i32 | 0i32 << 4i32 {
        ...
        __assert_fail(b"(((fi)->value_).gc)->tt == (6 | (0 << 4))\x00" as
                          *const u8 as *const libc::c_char,
                      b"lapi.c\x00" as *const u8 as *const libc::c_char,
                      1248i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 56],
    ...
    f = &mut (*((*fi).value_.gc as *mut GCUnion)).cl.l as *mut LClosure;
    if 1i32 <= n && n <= (*(*f).p).sizeupvalues &&
           !(b"invalid upvalue index\x00" as *const u8 as
                 *const libc::c_char).is_null() {
    } else {
        __assert_fail(b"((1 <= n && n <= f->p->sizeupvalues)) && \"invalid upvalue index\"\x00"
                          as *const u8 as *const libc::c_char,
                      b"lapi.c\x00" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub unsafe extern "C" fn lua_upvaluejoin(mut L: *mut lua_State_0,
    ...
    let mut up2: *mut *mut UpVal =
        getupvalref(L, fidx2, n2, 0 as *mut *mut LClosure);
