use lobject::{lua_TValue, unnamed_1, GCObject, Node, TKey, TString, TValue, Table, Value};
...
pub unsafe extern "C" fn luaH_getint(mut t: *mut Table, mut key: lua_Integer) -> *const TValue {
        ...
        < (*t).sizearray as libc::c_ulonglong
    {
        ...
        if 1i32 << (*t).lsizenode as libc::c_int & (1i32 << (*t).lsizenode as libc::c_int) - 1i32
            == 0i32
        {
        } else {
            __assert_fail(
                b"(((1<<((t)->lsizenode)))&(((1<<((t)->lsizenode)))-1))==0\x00" as *const u8
                    as *const libc::c_char,
                b"ltable.c\x00" as *const u8 as *const libc::c_char,
                503i32 as libc::c_uint,
                (*::std::mem::transmute::<&[u8; 48], &[libc::c_char; 48]>(
                    b"const TValue *luaH_getint(Table *, lua_Integer)\x00",
                )).as_ptr(),
            );
        };
    ...
    *cell = *value;
    if 0 == (*cell).tt_ & 1i32 << 6i32 || {
        if 0 != (*cell).tt_ & 1i32 << 6i32 {
            ...
            __assert_fail(
                b"((((cell))->tt_) & (1 << 6))\x00" as *const u8 as *const libc::c_char,
                b"ltable.c\x00" as *const u8 as *const libc::c_char,
                610i32 as libc::c_uint,
                (*::std::mem::transmute::<&[u8; 62], &[libc::c_char; 62]>(
                    b"void luaH_setint(lua_State *, Table *, lua_Integer, TValue *)\x00",
                )).as_ptr(),
            );
        };
        (*cell).tt_ & 0x3fi32 == (*(*cell).value_.gc).tt as libc::c_int
            && (L.is_null() || {
                if 0 != (*cell).tt_ & 1i32 << 6i32 {
                } else {
                    __assert_fail(
                ...
                0 != ((*(*cell).value_.gc).marked as libc::c_int ^ (1i32 << 0i32 | 1i32 << 1i32))
    ...
    if (*key).tt_ == 0i32 {
        ...
        if (*key).tt_ == 3i32 | 0i32 << 4i32 {
            ...
            if 0 != luaV_tointeger(key, &mut k, 0i32) {
                ...
                if (*key).tt_ == 3i32 | 0i32 << 4i32 {
                    ...
                    __assert_fail(
                        b"((((key))->tt_) == ((3 | (0 << 4))))\x00" as *const u8
                            as *const libc::c_char,
                        b"ltable.c\x00" as *const u8 as *const libc::c_char,
                        453i32 as libc::c_uint,
                        (*::std::mem::transmute::<&[u8; 58], &[libc::c_char; 58]>(
                            b"TValue *luaH_newkey(lua_State *, Table *, const TValue *)\x00",
                        )).as_ptr(),
                    );
                };
                if (*key).tt_ == 3i32 | 0i32 << 4i32 {
        ...
        if !((*mp).i_val.tt_ == 0i32) || (*t).lastfree.is_null() {
            ...
            if f.is_null() {
                ...
                if !(*t).lastfree.is_null() {
                    ...
                    __assert_fail(
                        b"!((t)->lastfree == ((void*)0))\x00" as *const u8 as *const libc::c_char,
                        b"ltable.c\x00" as *const u8 as *const libc::c_char,
        ...
        if 0 == (*io_).tt_ & 1i32 << 6i32 || {
            if 0 != (*io_).tt_ & 1i32 << 6i32 {
                ...
                __assert_fail(
                    b"(((io_)->tt_) & (1 << 6))\x00" as *const u8 as *const libc::c_char,
                    b"ltable.c\x00" as *const u8 as *const libc::c_char,
            ...
            (*io_).tt_ & 0x3fi32 == (*(*io_).value_.gc).tt as libc::c_int
                && (L.is_null() || {
                    if 0 != (*io_).tt_ & 1i32 << 6i32 {
                    } else {
                        __assert_fail(
                    ...
                    0 != ((*(*io_).value_.gc).marked as libc::c_int ^ (1i32 << 0i32 | 1i32 << 1i32))
                        & ((*(*L).l_G).currentwhite as libc::c_int ^ (1i32 << 0i32 | 1i32 << 1i32))
                })
        } {
        } else {
        ...
        if 0 != (*key).tt_ & 1i32 << 6i32 && 0 != (*t).marked as libc::c_int & 1i32 << 2i32 && {
            if 0 != (*key).tt_ & 1i32 << 6i32 {
            } else {
                __assert_fail(
                    b"(((key)->tt_) & (1 << 6))\x00" as *const u8 as *const libc::c_char,
                    b"ltable.c\x00" as *const u8 as *const libc::c_char,
        ...
        if (*mp).i_val.tt_ == 0i32 {
            ...
            __assert_fail(
                b"(((((&(mp)->i_val)))->tt_) == (0))\x00" as *const u8 as *const libc::c_char,
                b"ltable.c\x00" as *const u8 as *const libc::c_char,
    ...
    match (*key).tt_ & 0x3fi32 {
        19 => {
            if 1i32 << (*t).lsizenode as libc::c_int
                & (1i32 << (*t).lsizenode as libc::c_int) - 1i32
                == 0i32
            {
            } else {
                __assert_fail(
                    ...
                    (*::std::mem::transmute::<&[u8; 50], &[libc::c_char; 50]>(
                        b"Node *mainposition(const Table *, const TValue *)\x00",
                    )).as_ptr(),
                );
            };
            if (*key).tt_ == 3i32 | 1i32 << 4i32 {
                ...
                __assert_fail(
                    b"((((key))->tt_) == ((3 | (1 << 4))))\x00" as *const u8 as *const libc::c_char,
                    b"ltable.c\x00" as *const u8 as *const libc::c_char,
                    121i32 as libc::c_uint,
                    (*::std::mem::transmute::<&[u8; 50], &[libc::c_char; 50]>(
                        b"Node *mainposition(const Table *, const TValue *)\x00",
        ...
        3 => {
            if (*key).tt_ == 3i32 | 0i32 << 4i32 {
                ...
                __assert_fail(
                    b"((((key))->tt_) == ((3 | (0 << 4))))\x00" as *const u8 as *const libc::c_char,
                    b"ltable.c\x00" as *const u8 as *const libc::c_char,
        ...
        4 => {
            ...
            if (*key).tt_ & 0xfi32 == 4i32 {
            } else {
                __assert_fail(
                    b"(((((((key))->tt_)) & 0x0F)) == (4))\x00" as *const u8 as *const libc::c_char,
                    b"ltable.c\x00" as *const u8 as *const libc::c_char,
                    125i32 as libc::c_uint,
                    (*::std::mem::transmute::<&[u8; 50], &[libc::c_char; 50]>(
                        b"Node *mainposition(const Table *, const TValue *)\x00",
            ...
            if (*(*key).value_.gc).tt as libc::c_int & 0xfi32 == 4i32 {
            } else {
                __assert_fail(
                    b"(((((key)->value_).gc)->tt) & 0x0F) == 4\x00" as *const u8
                        as *const libc::c_char,
                    b"ltable.c\x00" as *const u8 as *const libc::c_char,
                    125i32 as libc::c_uint,
                    (*::std::mem::transmute::<&[u8; 50], &[libc::c_char; 50]>(
            ...
            return &mut *(*t).node.offset(
                ((*&mut (*((*key).value_.gc as *mut GCUnion)).ts).hash
        ...
        1 => {
            ...
            if (*key).tt_ == 1i32 {
                ...
                __assert_fail(
                    b"((((key))->tt_) == (1))\x00" as *const u8 as *const libc::c_char,
                    b"ltable.c\x00" as *const u8 as *const libc::c_char,
                    129i32 as libc::c_uint,
                    (*::std::mem::transmute::<&[u8; 50], &[libc::c_char; 50]>(
                        b"Node *mainposition(const Table *, const TValue *)\x00",
        ...
        2 => {
            if (*key).tt_ == 2i32 {
                ...
                __assert_fail(
                    b"((((key))->tt_) == (2))\x00" as *const u8 as *const libc::c_char,
                    b"ltable.c\x00" as *const u8 as *const libc::c_char,
        ...
        22 => {
            if (*key).tt_ == 6i32 | 1i32 << 4i32 {
                ...
                __assert_fail(
                    b"((((key))->tt_) == ((6 | (1 << 4))))\x00" as *const u8 as *const libc::c_char,
                    b"ltable.c\x00" as *const u8 as *const libc::c_char,
                    133i32 as libc::c_uint,
                    (*::std::mem::transmute::<&[u8; 50], &[libc::c_char; 50]>(
                        b"Node *mainposition(const Table *, const TValue *)\x00",
                    )).as_ptr(),
                );
        ...
        _ => {
            if !((*key).tt_ == 9i32 + 1i32) {
                ...
                __assert_fail(
                    b"!((((key))->tt_) == ((9+1)))\x00" as *const u8 as *const libc::c_char,
                    b"ltable.c\x00" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn l_hashfloat(mut n: lua_Number) -> libc::c_int {
    ...
    if !(n >= (-9223372036854775807i64 - 1i64) as libc::c_double
        ...
        if !(n == n) || fabs(n) == ::std::f64::INFINITY {
            ...
            __assert_fail(
                b"(!(((n))==((n)))) || fabs(n) == ((lua_Number)(((__builtin_huge_val ()))))\x00"
                    as *const u8 as *const libc::c_char,
                b"ltable.c\x00" as *const u8 as *const libc::c_char,
                103i32 as libc::c_uint,
                (*::std::mem::transmute::<&[u8; 28], &[libc::c_char; 28]>(
                    b"int l_hashfloat(lua_Number)\x00",
                )).as_ptr(),
            );
        };
        return 0i32;
        ...
        4 => {
            if (*key).tt_ & 0xfi32 == 4i32 {
                ...
                __assert_fail(
                    ...
                    (*::std::mem::transmute::<&[u8; 48], &[libc::c_char; 48]>(
                        b"const TValue *luaH_get(Table *, const TValue *)\x00",
                    )).as_ptr(),
                );
            };
            if (*(*key).value_.gc).tt as libc::c_int & 0xfi32 == 4i32 {
            ...
            return luaH_getshortstr(t, &mut (*((*key).value_.gc as *mut GCUnion)).ts);
        }
        19 => {
            if (*key).tt_ == 3i32 | 1i32 << 4i32 {
            } else {
...
pub unsafe extern "C" fn luaH_getshortstr(
        ...
        == 0i32
    {
        ...
        __assert_fail(
            ...
            (*::std::mem::transmute::<&[u8; 51], &[libc::c_char; 51]>(
                b"const TValue *luaH_getshortstr(Table *, TString *)\x00",
            )).as_ptr(),
        );
    };
    let mut n: *mut Node = &mut *(*t).node.offset(
    ...
    if (*key).tt as libc::c_int == 4i32 | 0i32 << 4i32 {
        ...
        __assert_fail(
            b"key->tt == (4 | (0 << 4))\x00" as *const u8 as *const libc::c_char,
            b"ltable.c\x00" as *const u8 as *const libc::c_char,
    ...
    loop {
        ...
        if (*k).tt_ == 4i32 | 0i32 << 4i32 | 1i32 << 6i32
            && {
                if (*k).tt_ & 0xfi32 == 4i32 {
                } else {
                    __assert_fail(
                        b"(((((((k))->tt_)) & 0x0F)) == (4))\x00" as *const u8
                            as *const libc::c_char,
                        b"ltable.c\x00" as *const u8 as *const libc::c_char,
                ...
                if (*(*k).value_.gc).tt as libc::c_int & 0xfi32 == 4i32 {
                } else {
                    __assert_fail(
                        b"(((((k)->value_).gc)->tt) & 0x0F) == 4\x00" as *const u8
                            as *const libc::c_char,
                        b"ltable.c\x00" as *const u8 as *const libc::c_char,
                        526i32 as libc::c_uint,
                        (*::std::mem::transmute::<&[u8; 51], &[libc::c_char; 51]>(
                ...
                if (*(&mut (*((*k).value_.gc as *mut GCUnion)).ts as *mut TString_0)).tt
                    as libc::c_int
                    == 4i32 | 0i32 << 4i32
                {
                } else {
                ...
                &mut (*((*k).value_.gc as *mut GCUnion)).ts as *mut TString_0 == key
            } {
            /* that's it */
            return &mut (*n).i_val;
        } else {
...
unsafe extern "C" fn computesizes(
    ...
    if (optimal == 0i32 as libc::c_uint || optimal.wrapping_div(2i32 as libc::c_uint) < na)
        && na <= optimal
    {
    } else {
        __assert_fail(
            b"(optimal == 0 || optimal / 2 < na) && na <= optimal\x00" as *const u8
                as *const libc::c_char,
            b"ltable.c\x00" as *const u8 as *const libc::c_char,
            236i32 as libc::c_uint,
            (*::std::mem::transmute::<&[u8; 58], &[libc::c_char; 58]>(
                b"unsigned int computesizes(unsigned int *, unsigned int *)\x00",
            )).as_ptr(),
        );
    };
    *pna = na;
        ...
        if (*key).tt_ == 3i32 | 1i32 << 4i32 {
            ...
            __assert_fail(
                ...
                (*::std::mem::transmute::<&[u8; 40], &[libc::c_char; 40]>(
                    b"unsigned int arrayindex(const TValue *)\x00",
                )).as_ptr(),
            );
        };
...
unsafe extern "C" fn numusearray(mut t: *const Table, mut nums: *mut libc::c_uint) -> libc::c_uint {
            ...
            .wrapping_sub(1i32 as libc::c_ulong) as libc::c_int
    {
        ...
        while i <= lim {
            if !((*(*t)
                .array
                .offset(i.wrapping_sub(1i32 as libc::c_uint) as isize)).tt_
                == 0i32)
            {
        ...
        if (*x_).tt as libc::c_int & 0xfi32 < 9i32 + 1i32 {
            ...
            __assert_fail(
                ...
                (*::std::mem::transmute::<&[u8; 46], &[libc::c_char; 46]>(
                    b"const TValue *luaH_getstr(Table *, TString *)\x00",
                )).as_ptr(),
            );
        };
            ...
            (*io).tt_ & 0x3fi32 == (*(*io).value_.gc).tt as libc::c_int
                && ((0 as *mut libc::c_void as *mut lua_State_0).is_null() || {
                    ...
                    0 != ((*(*io).value_.gc).marked as libc::c_int ^ (1i32 << 0i32 | 1i32 << 1i32))
                        & ((*(*(0 as *mut libc::c_void as *mut lua_State_0)).l_G).currentwhite
                            as libc::c_int
                            ^ (1i32 << 0i32 | 1i32 << 1i32))
                })
        } {
    ...
    if (*o).tt as libc::c_int == 5i32 {
        ...
        __assert_fail(
            ...
            (*::std::mem::transmute::<&[u8; 29], &[libc::c_char; 29]>(
                b"Table *luaH_new(lua_State *)\x00",
            )).as_ptr(),
        );
    };
                ...
                if 0 != (*io1).tt_ & 1i32 << 6i32 {
                    ...
                    __assert_fail(
                        ...
                        (*::std::mem::transmute::<&[u8; 43], &[libc::c_char; 43]>(
                            b"int luaH_next(lua_State *, Table *, StkId)\x00",
                        )).as_ptr(),
                    );
                };
                (*io1).tt_ & 0x3fi32 == (*(*io1).value_.gc).tt as libc::c_int
                ...
                if 0 != luaV_equalobj(
                    ...
                    && {
                            ...
                            == 9i32 + 1i32
                        {
                            ...
                            __assert_fail(
                                b"((((((const TValue*)((&(n)->i_key.tvk)))))->tt_) == ((9+1)))\x00"
                                    as *const u8
                                    as *const libc::c_char,
                                b"ltable.c\x00" as *const u8 as *const libc::c_char,
                                173i32 as libc::c_uint,
                                (*::std::mem::transmute::<&[u8; 52], &[libc::c_char; 52]>(
                                    b"unsigned int findindex(lua_State *, Table *, StkId)\x00",
                                )).as_ptr(),
                            );
                        };
                        if 0 != (*key).tt_ & 1i32 << 6i32 {
...
pub unsafe extern "C" fn luaH_getn(mut t: *mut Table) -> libc::c_int {
    ...
    if j > 0i32 as libc::c_uint
        && (*(*t)
            .array
            .offset(j.wrapping_sub(1i32 as libc::c_uint) as isize)).tt_
            == 0i32
    {
        ...
        while j.wrapping_sub(i) > 1i32 as libc::c_uint {
            ...
            if (*(*t)
                .array
                .offset(m.wrapping_sub(1i32 as libc::c_uint) as isize)).tt_
                == 0i32
            {
                j = m
            } else {
...
unsafe extern "C" fn unbound_search(mut t: *mut Table, mut j: libc::c_uint) -> libc::c_int {
    ...
    while !((*luaH_getint(t, j as lua_Integer)).tt_ == 0i32) {
        i = j;
        if j > (2147483647i32 as libc::c_uint).wrapping_div(2i32 as libc::c_uint) {
            /* overflow? */
            ...
            j = j.wrapping_mul(2i32 as libc::c_uint)
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn luaH_mainposition(
    mut t: *const Table,
    mut key: *const TValue,
) -> *mut Node {
...
pub unsafe extern "C" fn luaH_isdummy(mut t: *const Table) -> libc::c_int {
    return ((*t).lastfree == 0 as *mut libc::c_void as *mut Node) as libc::c_int;
}
